# Library certification · the_world_around_us III ch 1 · 20260813_180911
...
serve granularity: unit  ·  section axis: True
      registry <-> summary: 1 section(s) reached only through the standard's closing synthesis unit (taught, but outside the registry — read it at the human gate): Let us reflect
PASS  ch_01_canonical.json: every section the chapter summary carries is anchored by some unit (6 summary section(s) vs 5 registry entr(ies))
