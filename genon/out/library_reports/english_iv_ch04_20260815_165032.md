# Library certification · english IV ch 4 · 20260815_165032

plan: counts [10, 8, 6] · basis authored_standard · registry 5 sections

FAIL  library complete: ['ch_04_canonical.json'] vs plan [10, 8, 6]
...
PASS  ch_04_canonical.json: every question_type is a known assessment type (0 not)
      ADVISORY ch_04_canonical.json: ['FILL_IN', 'MCQ', 'WRITING_TASK'] used by exactly one item in the whole library — check it against the constitution's type table
...
serve sweep: {"4": "fill/single -2s", "5": "fill/single -1s", "6": "fill/single -1s", "7": "fill/single", "8": "synthesis", "9": "synthesis", "10": "identity", "11": "surrender", "12": "surrender"}
