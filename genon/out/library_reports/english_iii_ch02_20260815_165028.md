# Library certification · english III ch 2 · 20260815_165028

plan: counts [7, 4] · basis authored_standard · registry 4 sections

FAIL  library complete: ['ch_02_canonical.json'] vs plan [7, 4]
...
PASS  ch_02_canonical.json: every question_type is a known assessment type (0 not)
      ADVISORY ch_02_canonical.json: ['FILL_IN', 'MATCH', 'MCQ', 'SCR', 'TRUE_FALSE'] used by exactly one item in the whole library — check it against the constitution's type table
...
options arranged: 1 of 2 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ch_02_canonical.json: 1 of 2 item(s) re-ordered
