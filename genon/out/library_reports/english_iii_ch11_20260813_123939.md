# Library certification · english III ch 11 · 20260813_123939
...
PASS  ch_11_canonical.json: every question_type is a known assessment type (0 not)
      ADVISORY ch_11_canonical.json: ['FILL_IN', 'MCQ', 'SCR', 'TRUE_FALSE', 'WRITING_TASK'] used by exactly one item in the whole library — check it against the constitution's type table
...
serve sweep: {"5": "fill/single -2s", "6": "fill/single -1s", "7": "fill/single -1s", "8": "fill/single", "9": "fill/single", "10": "synthesis", "11": "synthesis", "12": "identity", "13": "surrender", "14": "surrender"}
...
options arranged: 1 of 2 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ch_11_canonical.json: 1 of 2 item(s) re-ordered
