# Library certification · social_sciences VI ch 5 · 20260816_092038
...
FAIL  ch_05_canonical.json: register clean (1 ban hit(s))
      U1 teacher_notes [forward] …ts' predictions about name-sources remain tentative so that later units can confirm or correct them.
...
item counts per competency — ADVISORY, does not gate; basis: derived (modal count across this library — no constitution row yet)
      expected {"Central": 5, "Present": 1, "Substantive": 3}
...
options arranged: 5 of 6 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ch_05_canonical.json: 5 of 6 item(s) re-ordered
          #1 C-2.1 U2: A–D now hold BADC · correct A -> B
          #2 C-2.1 U11: A–D now hold BDAC · correct A -> C
          #7 C-1.1 U10: A–D now hold BADC · correct A -> B
          #9 C-7.2 U3: A–D now hold CABD · correct A -> B
          #10 C-7.3 U9: A–D now hold ACBD · correct A -> A
