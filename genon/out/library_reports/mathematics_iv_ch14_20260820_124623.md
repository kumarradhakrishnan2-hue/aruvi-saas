# Library certification · mathematics IV ch 14 · 20260820_124623

plan: counts [8, 5] · basis authored_standard · registry 5 sections

PASS  library complete: ['ch_14_canonical.json', 'ch_14_canonical_p05.json'] vs plan [8, 5]
serve granularity: unit  ·  section axis: True
PASS  ch_14_canonical.json: every section the chapter summary carries is anchored by some unit (5 summary section(s) vs 5 registry entr(ies))
...
PASS  ch_14_canonical.json: register scan reached the band text (27 band(s) read: {'activity_title': 8, 'materials': 21, 'teacher_notes': 8, 'time_bands': 27, 'homework': 1})
PASS  ch_14_canonical.json: register clean (0 ban hit(s))
PASS  ch_14_canonical_p05.json: register scan reached the band text (20 band(s) read: {'activity_title': 5, 'materials': 10, 'teacher_notes': 5, 'time_bands': 20, 'homework': 1})
...
serve sweep: {"3": "fill/single -1s", "4": "fill/single", "5": "identity", "6": "fill/single", "7": "synthesis", "8": "identity", "9": "surrender", "10": "surrender"}
...
options arranged: 7 of 12 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ...
      ch_14_canonical_p05.json: 7 of 7 item(s) re-ordered
          #3 None #3: A–D now hold ADBC · correct B -> C
          #5 None #5: A–D now hold BCAD · correct C -> B
          #7 None #7: A–D now hold CADB · correct B -> D
          #8 None #8: A–D now hold DACB · correct C -> C
          #10 None #10: A–D now hold DABC · correct B -> C
          #11 None #11: A–D now hold ACBD · correct C -> B
          #12 None #12: A–D now hold ADCB · correct B -> D
