# Library certification · the_world_around_us V ch 5 · 20260811_195744
...
options arranged: 11 of 11 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ch_05_canonical.json: 4 of 4 item(s) re-ordered
          #1 C-1.2 U1: A–D now hold DBCA · correct C -> C
          #7 C-2.2 U7: A–D now hold ABDC · correct B -> B
          #10 C-2.2 U10: A–D now hold BADC · correct B -> A
          #13 C-4.2 U13: A–D now hold BCAD · correct C -> B
      ch_05_canonical_p10.json: 4 of 4 item(s) re-ordered
          #1 C-1.2 U1: A–D now hold CBAD · correct B -> B
          #3 C-4.7 U3: A–D now hold BDAC · correct B -> A
          #6 C-4.2 U6: A–D now hold DABC · correct B -> C
          #9 C-4.2 U9: A–D now hold BADC · correct C -> D
      ch_05_canonical_p13.json: 3 of 3 item(s) re-ordered
          #1 C-4.7 U1: A–D now hold BCDA · correct B -> A
          #5 C-4.7 U5: A–D now hold BACD · correct B -> A
          #10 C-2.2 U10: A–D now hold BACD · correct B -> A
