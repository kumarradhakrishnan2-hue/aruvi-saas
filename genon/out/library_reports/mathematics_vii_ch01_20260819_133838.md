# Library certification · mathematics VII ch 1 · 20260819_133838
...
PASS  ch_01_canonical.json: register scan reached the band text (44 band(s) read: {'activity_title': 11, 'materials': 23, 'teacher_notes': 11, 'time_bands': 44, 'homework': 7})
...
FAIL  ch_01_canonical_p09.json: register clean (1 ban hit(s))
      U1 time_bands[3] 32–40 [forward] …n system and previews that numbers grow much further, which the next unit will explore.
...
options arranged: 1 of 5 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ...
      ch_01_canonical_p09.json: 1 of 2 item(s) re-ordered
