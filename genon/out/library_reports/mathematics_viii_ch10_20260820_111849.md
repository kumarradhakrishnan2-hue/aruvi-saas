# Library certification · mathematics VIII ch 10 · 20260820_111849
...
PASS  ch_10_canonical.json: register scan reached the band text (49 band(s) read: {'activity_title': 12, 'materials': 36, 'teacher_notes': 12, 'time_bands': 49, 'visual_aids': 1})
PASS  ch_10_canonical.json: register clean (0 ban hit(s))
PASS  ch_10_canonical_p10.json: register scan reached the band text (40 band(s) read: {'activity_title': 10, 'materials': 36, 'teacher_notes': 10, 'time_bands': 40, 'homework': 5})
PASS  ch_10_canonical_p10.json: register clean (0 ban hit(s))
PASS  ch_10_canonical_p07.json: register scan reached the band text (33 band(s) read: {'activity_title': 7, 'materials': 20, 'teacher_notes': 7, 'time_bands': 33, 'homework': 4})
PASS  ch_10_canonical_p07.json: register clean (0 ban hit(s))
...
PASS  ch_10_canonical_p10.json: no stem points at a figure the item does not carry (0 does)
PASS  ch_10_canonical_p07.json: no stem points at a figure the item does not carry (0 does)
...
item counts per competency — ADVISORY, does not gate; basis: derived (modal count across this library — no constitution row yet)
      ...
      ch_10_canonical_p07.json: 0 items vs 0 expected
...
serve sweep: {"5": "fill/single", "6": "synthesis", "7": "identity", "8": "synthesis", "9": "synthesis", "10": "identity", "11": "synthesis", "12": "identity", "13": "surrender", "14": "surrender"}
...
options arranged: 0 of 6 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ...
      ch_10_canonical_p07.json: 0 of 2 item(s) re-ordered
      ch_10_canonical_p10.json: 0 of 2 item(s) re-ordered
