# Library certification · mathematics V ch 1 · 20260820_154014
...
PASS  ch_01_canonical.json: register scan reached the band text (28 band(s) read: {'activity_title': 9, 'materials': 26, 'teacher_notes': 9, 'time_bands': 28, 'homework': 5})
PASS  ch_01_canonical.json: register clean (0 ban hit(s))
PASS  ch_01_canonical_p07.json: register scan reached the band text (21 band(s) read: {'activity_title': 7, 'materials': 18, 'teacher_notes': 7, 'time_bands': 21, 'homework': 3})
...
serve sweep: {"3": "fill/forward -2s", "4": "fill/single -1s", "5": "identity", "6": "rescue/complete (from 7)", "7": "identity", "8": "fill/single", "9": "identity", "10": "surrender", "11": "surrender"}

options arranged: 4 of 15 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ch_01_canonical.json: 0 of 7 item(s) re-ordered
      ch_01_canonical_p05.json: 0 of 4 item(s) re-ordered
      ch_01_canonical_p07.json: 4 of 4 item(s) re-ordered
          #3 None #3: A–D now hold CADB · correct A -> B
          #5 None #5: A–D now hold CBAD · correct B -> B
          #8 None #8: A–D now hold DBCA · correct A -> D
          #10 None #10: A–D now hold ABDC · correct C -> D
