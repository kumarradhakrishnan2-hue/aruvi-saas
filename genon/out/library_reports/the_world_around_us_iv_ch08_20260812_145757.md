# Library certification · the_world_around_us IV ch 8 · 20260812_145757
...
PASS  ch_08_canonical_p11.json: every handoff row routes to a unit that anchors its section
      ...
      ADVISORY ch_08_canonical_p11.json: 11 unit(s) wear a section label the handoff does not route items through: U1=how paper is made, U2=how paper is made, U3=how paper is made, U4=how paper is made, U5=different types of paper and their uses, U6=making responsible choices …  (do NOT extend period_numbers to fix this — it moves the item to a later unit and loses it on short serves)
PASS  ch_08_canonical_p08.json: every handoff row routes to a unit that anchors its section
      ...
      ADVISORY ch_08_canonical_p08.json: 8 unit(s) wear a section label the handoff does not route items through: U1=how paper is made, U2=how paper is made, U3=how paper is made, U4=how paper is made, U5=making responsible choices, U6=let us get creative with paper …  (do NOT extend period_numbers to fix this — it moves the item to a later unit and loses it on short serves)
...
PASS  ch_08_canonical_p11.json: register scan reached the band text (44 band(s) read: {'activity_title': 11, 'materials': 49, 'visual_aids': 9, 'teacher_facilitation_note': 11, 'time_bands': 44})
FAIL  ch_08_canonical_p11.json: register clean (1 ban hit(s))
      U9 time_bands[1] 10-24 [calendar] …d of 'use less paper', what exactly will you do differently tomorrow morning?
      -> declare the fixes in genon/repair_register.py and re-run --certify-only; do NOT hand-edit the artefact
PASS  ch_08_canonical_p08.json: register scan reached the band text (33 band(s) read: {'activity_title': 8, 'materials': 41, 'visual_aids': 4, 'teacher_facilitation_note': 8, 'time_bands': 33})
...
item counts per competency — ADVISORY, does not gate; basis: derived (modal count across this library — no constitution row yet)
      ...
      ch_08_canonical_p11.json: 11 items vs 11 expected
...
serve sweep: {"6": "fill/single -2s", "7": "fill/single -1s", "8": "identity", "9": "fill/single", "10": "synthesis", "11": "identity", "12": "fill/single", "13": "identity", "14": "surrender", "15": "surrender"}
...
options arranged: 5 of 9 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ...
      ch_08_canonical_p08.json: 3 of 3 item(s) re-ordered
          #1 C-4.3 U1: A–D now hold DCBA · correct A -> D
          #5 C-4.4 U5: A–D now hold ADCB · correct B -> D
          #8 C-4.3 U8: A–D now hold DCAB · correct B -> D
      ch_08_canonical_p11.json: 2 of 2 item(s) re-ordered
          #1 C-4.3 U1: A–D now hold DCBA · correct A -> D
          #5 C-4.3 U5: A–D now hold DBCA · correct B -> B
QUARANTINED  ch_08_canonical_p11.json -> backup/quarantine/the_world_around_us/iv/ch_08_canonical_p11_20260812_145757.json
