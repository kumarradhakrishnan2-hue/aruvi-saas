# Library certification · english V ch 8 · 20260815_183413
...
PASS  ch_08_canonical.json: register scan reached the band text (55 band(s) read: {'activity_title': 14, 'materials': 27, 'teacher_notes': 14, 'time_bands': 55})
PASS  ch_08_canonical.json: register clean (0 ban hit(s))
PASS  ch_08_canonical_p11.json: register scan reached the band text (46 band(s) read: {'activity_title': 11, 'materials': 20, 'teacher_notes': 11, 'time_bands': 46})
PASS  ch_08_canonical_p11.json: register clean (0 ban hit(s))
PASS  ch_08_canonical_p08.json: register scan reached the band text (41 band(s) read: {'activity_title': 8, 'materials': 13, 'teacher_notes': 8, 'time_bands': 41, 'homework': 1})
FAIL  ch_08_canonical_p08.json: register clean (1 ban hit(s))
      U2 time_bands[2] 15–27 [clock] …('What was the final judgment?'). Students discuss in pairs for two minutes, then share answers; teacher corrects and consolidates on t…
...
serve sweep: {"6": "fill/single -1s", "7": "fill/single", "8": "identity", "9": "rescue/complete (from 11)", "10": "fill/single", "11": "identity", "12": "synthesis", "13": "synthesis", "14": "identity", "15": "surrender", "16": "surrender"}
...
options arranged: 5 of 7 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ...
      ch_08_canonical_p08.json: 2 of 2 item(s) re-ordered
          #1 None #1: A–D now hold CDAB · correct A -> C
          #3 None #3: A–D now hold 2413 · correct 1 -> 3
      ch_08_canonical_p11.json: 3 of 3 item(s) re-ordered
          #1 None #1: A–D now hold CADB · correct B -> D
          #3 None #3: A–D now hold DBCA · correct B -> B
          #9 None #9: A–D now hold 3241 · correct 3 -> 1
