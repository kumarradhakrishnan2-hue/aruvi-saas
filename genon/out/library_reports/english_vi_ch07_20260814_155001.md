# Library certification · english VI ch 7 · 20260814_155001
...
FAIL  library complete: ['ch_07_canonical.json'] vs plan [7, 4]
...
PASS  ch_07_canonical.json: every question_type is a known assessment type (0 not)
      ADVISORY ch_07_canonical.json: ['ECR', 'MATCH', 'PROJECT', 'TRUE_FALSE'] used by exactly one item in the whole library — check it against the constitution's type table
...
serve sweep: {"2": "fill/backward -3s", "3": "fill/backward -3s", "4": "fill/single -2s", "5": "fill/single -1s", "6": "fill/single", "7": "identity", "8": "surrender", "9": "surrender"}
...
options arranged: 2 of 3 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ch_07_canonical.json: 2 of 3 item(s) re-ordered
