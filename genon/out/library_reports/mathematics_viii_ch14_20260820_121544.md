# Library certification · mathematics VIII ch 14 · 20260820_121544
...
PASS  ch_14_canonical.json: register scan reached the band text (57 band(s) read: {'activity_title': 14, 'materials': 51, 'teacher_notes': 14, 'time_bands': 57, 'homework': 4, 'visual_aids': 1})
FAIL  ch_14_canonical.json: register clean (2 ban hit(s))
      U14 teacher_notes [clock] …king for the first 18 minutes, then compare in small groups for 10 minutes — any disagreement must be reconstructed step by step, not…
      U14 teacher_notes [clock] …board; students work individually with full written working for the first 18 minutes, then compare in small groups for 10 minutes — any disagree…
