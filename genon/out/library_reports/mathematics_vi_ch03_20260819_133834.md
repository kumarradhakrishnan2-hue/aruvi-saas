# Library certification · mathematics VI ch 3 · 20260819_133834
...
PASS  ch_03_canonical.json: register scan reached the band text (48 band(s) read: {'activity_title': 12, 'materials': 18, 'teacher_notes': 12, 'time_bands': 48, 'homework': 4})
...
options arranged: 3 of 6 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ...
      ch_03_canonical_p07.json: 1 of 2 item(s) re-ordered
          #9 None #9: A–D now hold DBCA · correct D -> A
      ch_03_canonical_p10.json: 2 of 2 item(s) re-ordered
          #3 None #3: A–D now hold DACB · correct B -> D
          #11 None #11: A–D now hold BCDA · correct B -> A
