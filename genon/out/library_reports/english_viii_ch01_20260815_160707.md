# Library certification · english VIII ch 1 · 20260815_160707
...
PASS  ch_01_canonical.json: register scan reached the band text (24 band(s) read: {'activity_title': 8, 'materials': 16, 'teacher_notes': 8, 'time_bands': 24, 'homework': 2})
PASS  ch_01_canonical.json: register clean (0 ban hit(s))
PASS  ch_01_canonical_p05.json: register scan reached the band text (15 band(s) read: {'activity_title': 5, 'materials': 11, 'teacher_notes': 5, 'time_bands': 15, 'homework': 1})
...
PASS  ch_01_canonical.json: every question_type is a known assessment type (0 not)
      ADVISORY ch_01_canonical.json: ['FILL_IN'] used by exactly one item in the whole library — check it against the constitution's type table
...
serve sweep: {"3": "fill/single -3s", "4": "fill/single -2s", "5": "identity", "6": "rescue/complete (from 8)", "7": "fill/backward", "8": "identity", "9": "surrender", "10": "surrender"}
...
options arranged: 2 of 4 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ...
      ch_01_canonical_p05.json: 2 of 2 item(s) re-ordered
          #1 None #1: A–D now hold ABDC · correct C -> D
          #3 None #3: A–D now hold 2431 · correct 2 -> 1
