# Library certification · the_world_around_us V ch 9 · 20260813_180155
...
PASS  ch_09_canonical.json: every section the chapter summary carries is anchored by some unit (4 summary section(s) vs 4 registry entr(ies))
...
PASS  ch_09_canonical_p10.json: register clean (0 ban hit(s))
      ADVISORY ch_09_canonical_p10.json: 2 artefact-dependency hit(s) — a unit reaching for something a PREVIOUS sitting produced. Read them: the brief forbids it, certification cannot.
        U2 time_bands[0] 0–8: 'from the previous unit' — …', 'Minutes or Seconds'. The class quickly recalls examples from the previous unit's conversation to populate each column — one or two entries…
        U4 time_bands[0] 0–7: 'from the previous unit' — The teacher briefly re-runs the torch-and-globe setup from the previous unit's work. She positions the torch so that India is in full da…
...
PASS  ch_09_canonical_p07.json: register clean (0 ban hit(s))
      ADVISORY ch_09_canonical_p07.json: 1 artefact-dependency hit(s) — a unit reaching for something a PREVIOUS sitting produced. Read them: the brief forbids it, certification cannot.
        U5 time_bands[0] 0-10: 'from the previous unit' — The teacher revisits the six season names from the previous unit's closing moment and writes them on the board: Vasanta, Gri…
