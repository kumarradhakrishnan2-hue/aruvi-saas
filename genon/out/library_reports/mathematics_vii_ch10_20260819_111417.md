# Library certification · mathematics VII ch 10 · 20260819_111417
...
FAIL  ch_10_canonical.json: register clean (1 ban hit(s))
      U4 teacher_notes [forward] …orrectly before moving to the pattern-based confirmation in the next unit.
...
serve sweep: {"5": "synthesis", "6": "synthesis", "7": "synthesis", "8": "synthesis", "9": "synthesis", "10": "synthesis", "11": "synthesis", "12": "identity", "13": "surrender", "14": "surrender"}
...
options arranged: 2 of 2 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ch_10_canonical.json: 2 of 2 item(s) re-ordered
          #1 None #1: A–D now hold BACD · correct C -> C
