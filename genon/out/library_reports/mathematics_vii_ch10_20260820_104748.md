# Library certification · mathematics VII ch 10 · 20260820_104748

plan: counts [12, 10, 7] · basis authored_standard · registry 2 sections
...
PASS  ch_10_canonical.json: register scan reached the band text (49 band(s) read: {'activity_title': 12, 'materials': 17, 'teacher_notes': 12, 'time_bands': 49, 'visual_aids': 1})
FAIL  ch_10_canonical.json: register clean (1 ban hit(s))
      U12 teacher_notes [clock] …r problems at once on the board. Students work individually for the first fifteen minutes — full written working, no shortcuts. They then compare in…
      -> declare the fixes in genon/repair_register.py and re-run --certify-only; do NOT hand-edit the artefact
PASS  ch_10_canonical_p10.json: register scan reached the band text (39 band(s) read: {'activity_title': 10, 'materials': 23, 'teacher_notes': 10, 'time_bands': 39})
PASS  ch_10_canonical_p10.json: register clean (0 ban hit(s))
      ADVISORY ch_10_canonical_p10.json: 1 artefact-dependency hit(s) — a unit reaching for something a PREVIOUS sitting produced. Read them: the brief forbids it, certification cannot.
        U5 time_bands[1] 10–18: 'from the previous unit' — …nd ask students to match each rule to one of the four cases from the previous unit. Note that this is the first recorded articulation of sign…
PASS  ch_10_canonical_p07.json: register scan reached the band text (28 band(s) read: {'activity_title': 7, 'materials': 14, 'teacher_notes': 7, 'time_bands': 28})
...
serve sweep: {"5": "synthesis", "6": "synthesis", "7": "identity", "8": "synthesis", "9": "synthesis", "10": "identity", "11": "synthesis", "12": "identity", "13": "surrender", "14": "surrender"}
...
options arranged: 0 of 4 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ...
      ch_10_canonical_p07.json: 0 of 1 item(s) re-ordered
      ch_10_canonical_p10.json: 0 of 1 item(s) re-ordered
