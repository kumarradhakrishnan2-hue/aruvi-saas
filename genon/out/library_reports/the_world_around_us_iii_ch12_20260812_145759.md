# Library certification · the_world_around_us III ch 12 · 20260812_145759
...
FAIL  ch_12_canonical_p13.json: register clean (2 ban hit(s))
      U4 time_bands[1] 8-24 [clock] …person who cleans it, or everyone who uses it? Groups talk for a few minutes, then a speaker from each group shares one idea. Teacher no…
      U6 time_bands[3] 34-40 [calendar] …ether and each privately decides: which of these will I try this week? No public commitment is required — the choice is personal.…
...
options arranged: 5 of 9 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ...
      ch_12_canonical_p10.json: 2 of 2 item(s) re-ordered
          #1 C-3.1 U1: A–D now hold BDCA · correct A -> D
          #7 C-4.7 U7: A–D now hold BCAD · correct A -> C
      ch_12_canonical_p13.json: 3 of 3 item(s) re-ordered
          #1 C-3.1 U1: A–D now hold DBCA · correct B -> B
          #3 C-3.1 U3: A–D now hold CADB · correct A -> B
          #7 C-1.2 U7: A–D now hold CADB · correct B -> D
