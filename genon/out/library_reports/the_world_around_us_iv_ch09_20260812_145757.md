# Library certification · the_world_around_us IV ch 9 · 20260812_145757

plan: counts [16, 13, 10] · basis authored_standard · registry 6 sections

PASS  library complete: ['ch_09_canonical.json', 'ch_09_canonical_p13.json', 'ch_09_canonical_p10.json'] vs plan [16, 13, 10]
...
FAIL  ch_09_canonical_p10.json: every anchor verbatim in the top registry
FAIL  ch_09_canonical_p10.json: first-visit order follows the registry
...
PASS  ch_09_canonical.json: every handoff row routes to a unit that anchors its section
      ...
      ADVISORY ch_09_canonical.json: 15 unit(s) wear a section label the handoff does not route items through: U1=back to school from holidays, U2=in the land of agriculture, with gurpreet, U3=in the land of agriculture, with gurpreet, U4=in the land of endless sand, with ritika, U5=in the land of endless sand, with ritika, U6=on the seashore, with chandni …  (do NOT extend period_numbers to fix this — it moves the item to a later unit and loses it on short serves)
PASS  ch_09_canonical_p13.json: every handoff row routes to a unit that anchors its section
      ...
      ADVISORY ch_09_canonical_p13.json: 13 unit(s) wear a section label the handoff does not route items through: U1=back to school from holidays, U2=in the land of agriculture, with gurpreet, U3=in the land of agriculture, with gurpreet, U4=in the land of endless sand, with ritika, U5=in the land of endless sand, with ritika, U6=on the seashore, with chandni …  (do NOT extend period_numbers to fix this — it moves the item to a later unit and loses it on short serves)
PASS  ch_09_canonical_p10.json: every handoff row routes to a unit that anchors its section
      ...
      ADVISORY ch_09_canonical_p10.json: 10 unit(s) wear a section label the handoff does not route items through: U1=back to school from holidays, U2=in the land of agriculture, with gurpreet, U3=in the land of agriculture, with gurpreet, U4=in the land of endless sand, with ritika, U5=in the land of endless sand, with ritika, U6=on the seashore, with chandni …  (do NOT extend period_numbers to fix this — it moves the item to a later unit and loses it on short serves)
PASS  ch_09_canonical.json: register scan reached the band text (64 band(s) read: {'activity_title': 16, 'materials': 56, 'visual_aids': 9, 'teacher_facilitation_note': 16, 'time_bands': 64})
PASS  ch_09_canonical.json: register clean (0 ban hit(s))
PASS  ch_09_canonical_p13.json: register scan reached the band text (52 band(s) read: {'activity_title': 13, 'materials': 47, 'visual_aids': 10, 'teacher_facilitation_note': 13, 'time_bands': 52})
PASS  ch_09_canonical_p13.json: register clean (0 ban hit(s))
PASS  ch_09_canonical_p10.json: register scan reached the band text (40 band(s) read: {'activity_title': 10, 'materials': 36, 'teacher_facilitation_note': 10, 'time_bands': 40, 'visual_aids': 6})
...
item counts per competency — ADVISORY, does not gate; basis: derived (modal count across this library — no constitution row yet)
      expected {}
      ch_09_canonical.json: 16 items vs 16 expected
      ch_09_canonical_p13.json: 13 items vs 13 expected
      ch_09_canonical_p10.json: 10 items vs 10 expected
...
options arranged: 7 of 12 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ch_09_canonical.json: 0 of 5 item(s) re-ordered
      ch_09_canonical_p10.json: 3 of 3 item(s) re-ordered
          #1 C-6.2 U1: A–D now hold DABC · correct C -> D
          #3 C-2.2 U3: A–D now hold ABDC · correct B -> B
          #6 C-1.1 U6: A–D now hold DCAB · correct D -> A
      ch_09_canonical_p13.json: 4 of 4 item(s) re-ordered
          #1 C-6.2 U1: A–D now hold ACDB · correct B -> D
          #4 C-1.1 U4: A–D now hold BDCA · correct B -> A
          #6 C-4.2 U6: A–D now hold DBCA · correct B -> B
          #12 C-4.2 U12: A–D now hold CBDA · correct C -> A
QUARANTINED  ch_09_canonical_p10.json -> backup/quarantine/the_world_around_us/iv/ch_09_canonical_p10_20260812_145757.json
