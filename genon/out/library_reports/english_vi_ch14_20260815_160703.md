# Library certification · english VI ch 14 · 20260815_160703
...
PASS  ch_14_canonical.json: register scan reached the band text (29 band(s) read: {'activity_title': 9, 'materials': 19, 'teacher_notes': 9, 'time_bands': 29})
PASS  ch_14_canonical.json: register clean (0 ban hit(s))
PASS  ch_14_canonical_p07.json: register scan reached the band text (21 band(s) read: {'activity_title': 7, 'materials': 15, 'teacher_notes': 7, 'time_bands': 21, 'homework': 2})
PASS  ch_14_canonical_p07.json: register clean (0 ban hit(s))
PASS  ch_14_canonical_p05.json: register scan reached the band text (16 band(s) read: {'activity_title': 5, 'materials': 7, 'teacher_notes': 5, 'time_bands': 16, 'homework': 1})
...
options arranged: 3 of 6 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ...
      ch_14_canonical_p05.json: 1 of 2 item(s) re-ordered
          #3 None #3: A–D now hold 3412 · correct 3 -> 1
      ch_14_canonical_p07.json: 2 of 2 item(s) re-ordered
          #1 None #1: A–D now hold ABDC · correct A -> A
          #3 None #3: A–D now hold 321 · correct 3 -> 1
