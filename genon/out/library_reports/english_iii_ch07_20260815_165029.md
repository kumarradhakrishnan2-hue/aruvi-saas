# Library certification · english III ch 7 · 20260815_165029
...
PASS  ch_07_canonical.json: every question_type is a known assessment type (0 not)
      ADVISORY ch_07_canonical.json: ['FILL_IN', 'MATCH', 'MCQ', 'PROJECT', 'SCR', 'TRUE_FALSE'] used by exactly one item in the whole library — check it against the constitution's type table
...
serve sweep: {"2": "fill/single -2s", "3": "fill/single -2s", "4": "fill/single -1s", "5": "fill/single -1s", "6": "fill/single", "7": "identity", "8": "surrender", "9": "surrender"}
