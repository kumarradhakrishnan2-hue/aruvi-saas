# Library certification · english VII ch 13 · 20260814_155005
...
PASS  ch_13_canonical.json: every question_type is a known assessment type (0 not)
      ADVISORY ch_13_canonical.json: ['ECR', 'MATCH', 'MCQ', 'PROJECT', 'TRUE_FALSE'] used by exactly one item in the whole library — check it against the constitution's type table
...
serve sweep: {"3": "fill/forward -3s", "4": "fill/forward -3s", "5": "fill/forward -3s", "6": "fill/single -2s", "7": "fill/forward", "8": "fill/forward", "9": "identity", "10": "surrender", "11": "surrender"}
