# Library certification · social_sciences VII ch 2 · 20260816_092040
...
PASS  ch_02_canonical.json: every question_type is a known assessment type (0 not)
      ADVISORY ch_02_canonical.json: ['ECR', 'OPEN_TASK', 'SCR'] used by exactly one item in the whole library — check it against the constitution's type table
...
serve sweep: {"3": "fill/single -2s", "4": "fill/single -1s", "5": "fill/single -1s", "6": "fill/single -1s", "7": "fill/single", "8": "synthesis", "9": "identity", "10": "surrender", "11": "surrender"}
...
options arranged: 4 of 4 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ch_02_canonical.json: 4 of 4 item(s) re-ordered
          #1 C-6.1 U1: A–D now hold ABDC · correct A -> A
          #2 C-6.1 U2: A–D now hold CBDA · correct A -> D
          #6 C-1.2 U3: A–D now hold BACD · correct A -> B
          #7 C-1.2 U3: A–D now hold BADC · correct A -> B
