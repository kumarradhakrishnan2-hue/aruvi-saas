# Library certification · english IX ch 14 · 20260814_135118
...
FAIL  ch_14_canonical_p07.json: register clean (1 ban hit(s))
      ADVISORY ch_14_canonical_p07.json: 1 artefact-dependency hit(s) — a unit reaching for something a PREVIOUS sitting produced. Read them: the brief forbids it, certification cannot.
        U6 time_bands[2] 30–50: 'revise their draft' — …rargument is present; writers note feedback and complete or revise their draft within the remaining time.
      U6 time_bands[2] 30–50 [clock] …ers note feedback and complete or revise their draft within the remaining time.
...
FAIL  ch_14_canonical_p05.json: register clean (1 ban hit(s))
      U2 teacher_notes [forward] …as self-study for students to complete independently before the next unit teaches device analysis further.
      -> declare the fixes in genon/repair_register.py and re-run --certify-only; do NOT hand-edit the artefact
...
options arranged: 4 of 6 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ...
      ch_14_canonical_p05.json: 2 of 2 item(s) re-ordered
          #1 None #1: A–D now hold DABC · correct B -> C
          #3 None #3: A–D now hold 3241 · correct 3 -> 1
      ch_14_canonical_p07.json: 2 of 2 item(s) re-ordered
