# Library certification · social_sciences VII ch 5 · 20260816_101636
...
options arranged: 20 of 30 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ...
      ch_05_canonical_p11.json: 10 of 10 item(s) re-ordered
          #1 C-2.1 U1: A–D now hold CDAB · correct B -> D
          #2 C-2.1 U11: A–D now hold ABDC · correct B -> B
          #6 C-3.1 U2: A–D now hold DCBA · correct B -> C
          #7 C-3.1 U9: A–D now hold DBAC · correct A -> C
          #9 C-3.2 U4: A–D now hold BCAD · correct C -> B
          #10 C-3.2 U8: A–D now hold CABD · correct B -> C
          #11 C-4.1 U2: A–D now hold ADCB · correct B -> D
          #12 C-4.1 U7: A–D now hold BDCA · correct D -> B
          #13 C-10.1 U7: A–D now hold DBCA · correct B -> B
          #14 C-10.1 U10: A–D now hold CBAD · correct B -> B
      ch_05_canonical_p15.json: 10 of 10 item(s) re-ordered
          #1 C-2.1 U1: A–D now hold BACD · correct B -> A
          #2 C-2.1 U12: A–D now hold ADBC · correct C -> D
          #6 C-3.1 U4: A–D now hold CADB · correct B -> D
          #7 C-3.1 U11: A–D now hold ABDC · correct C -> D
          #9 C-3.2 U6: A–D now hold CDAB · correct B -> D
          #10 C-3.2 U15: A–D now hold CABD · correct B -> C
          #11 C-4.1 U4: A–D now hold CADB · correct B -> D
          #12 C-4.1 U9: A–D now hold ADBC · correct B -> C
          #13 C-10.1 U10: A–D now hold ADBC · correct B -> C
          #14 C-10.1 U14: A–D now hold CBAD · correct B -> B
