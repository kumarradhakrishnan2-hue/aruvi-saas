# Library certification · the_world_around_us III ch 7 · 20260812_145758
...
options arranged: 5 of 9 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ...
      ch_07_canonical_p08.json: 2 of 2 item(s) re-ordered
          #1 C-1.3 U1: A–D now hold BDCA · correct B -> A
          #3 C-1.1 U3: A–D now hold ACBD · correct C -> B
      ch_07_canonical_p11.json: 3 of 3 item(s) re-ordered
          #1 C-1.3 U1: A–D now hold CBDA · correct A -> D
          #3 C-1.1 U3: A–D now hold ADBC · correct B -> C
          #7 C-6.1 U7: A–D now hold DABC · correct B -> C
