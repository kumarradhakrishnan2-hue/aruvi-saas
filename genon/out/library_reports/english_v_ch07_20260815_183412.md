# Library certification · english V ch 7 · 20260815_183412
...
FAIL  ch_07_canonical_p15.json: register clean (1 ban hit(s))
      U1 teacher_notes [forward] …t defining them fully yet, as word meaning is explored in a later unit.
...
FAIL  ch_07_canonical_p11.json: register clean (1 ban hit(s))
      U3 time_bands[1] 6–18 [clock] …y playing outdoors? Why or why not?' Students talk in pairs for two minutes, then four or five individuals share with the class. Teache…
      -> declare the fixes in genon/repair_register.py and re-run --certify-only; do NOT hand-edit the artefact
...
options arranged: 5 of 7 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ...
      ch_07_canonical_p11.json: 3 of 3 item(s) re-ordered
          ...
          #3 None #3: A–D now hold 231 · correct 1 -> 3
          #5 None #5: A–D now hold CDBA · correct A -> D
      ch_07_canonical_p15.json: 2 of 2 item(s) re-ordered
          #1 None #1: A–D now hold DACB · correct A -> B
          #3 None #3: A–D now hold 3421 · correct 1 -> 4
