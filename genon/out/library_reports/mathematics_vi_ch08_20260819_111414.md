# Library certification · mathematics VI ch 8 · 20260819_111414

plan: counts [23, 19, 14] · basis authored_standard · registry 6 sections

FAIL  library complete: ['ch_08_canonical.json'] vs plan [23, 19, 14]
...
PASS  ch_08_canonical.json: every question_type is a known assessment type (0 not)
      ADVISORY ch_08_canonical.json: ['ECR', 'MCQ'] used by exactly one item in the whole library — check it against the constitution's type table
...
serve sweep: {"12": "fill/single", "13": "fill/single", "14": "fill/single", "15": "synthesis", "16": "synthesis", "17": "synthesis", "18": "synthesis", "19": "synthesis", "20": "synthesis", "21": "synthesis", "22": "synthesis", "23": "identity", "24": "surrender", "25": "surrender"}
...
options arranged: 1 of 1 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ch_08_canonical.json: 1 of 1 item(s) re-ordered
