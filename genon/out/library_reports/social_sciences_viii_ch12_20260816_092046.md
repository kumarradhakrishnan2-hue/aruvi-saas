# Library certification · social_sciences VIII ch 12 · 20260816_092046
...
FAIL  ch_12_canonical.json: register clean (2 ban hit(s))
      U3 teacher_notes [forward] …onstitutional Articles' will give them granular detail in a later unit.
      U5 time_bands[0] 0-10 [clock] …chools handle student opinions? Students think individually for two minutes, then share responses orally.
...
options arranged: 11 of 12 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ch_12_canonical.json: 11 of 12 item(s) re-ordered
          #1 C-8.1 U3: A–D now hold CADB · correct A -> B
          #2 C-8.1 U10: A–D now hold BACD · correct A -> B
          #6 C-5.1 U11: A–D now hold DACB · correct A -> B
          #7 C-5.1 U13: A–D now hold CBAD · correct A -> C
          #9 C-5.2 U4: A–D now hold CABD · correct A -> B
          #10 C-5.2 U12: A–D now hold DCBA · correct A -> D
          #12 C-4.2 U6: A–D now hold CBAD · correct A -> C
          #13 C-4.2 U6: A–D now hold BCAD · correct A -> C
          #14 C-7.1 U6: A–D now hold DACB · correct A -> B
          #15 C-7.1 U6: A–D now hold ABDC · correct A -> A
          #16 C-10.1 U9: A–D now hold CADB · correct A -> B
