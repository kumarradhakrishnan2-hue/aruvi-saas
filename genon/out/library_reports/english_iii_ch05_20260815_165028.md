# Library certification · english III ch 5 · 20260815_165028

plan: counts [4, 2] · basis authored_standard · registry 1 sections

FAIL  library complete: ['ch_05_canonical.json'] vs plan [4, 2]
...
PASS  ch_05_canonical.json: every question_type is a known assessment type (0 not)
      ADVISORY ch_05_canonical.json: ['MCQ', 'ORAL_PROMPT'] used by exactly one item in the whole library — check it against the constitution's type table
...
serve sweep: {"1": "fill/single", "2": "synthesis", "3": "synthesis", "4": "identity", "5": "surrender", "6": "surrender"}
...
options arranged: 1 of 1 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ch_05_canonical.json: 1 of 1 item(s) re-ordered
          #1 None #1: A–D now hold ACDB · correct D -> C
