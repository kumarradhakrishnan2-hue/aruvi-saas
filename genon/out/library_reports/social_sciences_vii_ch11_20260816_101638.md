# Library certification · social_sciences VII ch 11 · 20260816_101638
...
options arranged: 12 of 18 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ...
      ch_11_canonical_p08.json: 6 of 6 item(s) re-ordered
          #1 C-9.1 U1: A–D now hold DCBA · correct A -> D
          #2 C-9.1 U2: A–D now hold DBCA · correct A -> D
          #6 C-2.1 U5: A–D now hold BADC · correct A -> B
          #7 C-2.1 U6: A–D now hold DBCA · correct A -> D
          #9 C-10.1 U1: A–D now hold ACBD · correct A -> A
          #10 C-10.1 U6: A–D now hold DABC · correct A -> B
      ch_11_canonical_p11.json: 6 of 6 item(s) re-ordered
          #1 C-9.1 U1: A–D now hold CABD · correct B -> C
          #2 C-9.1 U8: A–D now hold DCAB · correct C -> B
          #6 C-2.1 U6: A–D now hold DABC · correct B -> C
          #7 C-2.1 U11: A–D now hold CBAD · correct C -> A
          #9 C-10.1 U3: A–D now hold CBAD · correct B -> B
          #10 C-10.1 U9: A–D now hold CBAD · correct C -> A
