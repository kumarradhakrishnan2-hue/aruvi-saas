# Library certification · mathematics V ch 1 · 20260820_124623

plan: counts [9, 7, 5] · basis authored_standard · registry 7 sections

FAIL  library complete: ['ch_01_canonical.json', 'ch_01_canonical_p05.json'] vs plan [9, 7, 5]
...
serve sweep: {"3": "fill/forward -2s", "4": "fill/single -1s", "5": "identity", "6": "rescue/complete (from 9)", "7": "fill/single", "8": "fill/single", "9": "identity", "10": "surrender", "11": "surrender"}

options arranged: 4 of 11 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ch_01_canonical.json: 0 of 7 item(s) re-ordered
      ch_01_canonical_p05.json: 4 of 4 item(s) re-ordered
