# Library certification · english V ch 1 · 20260815_165034
...
FAIL  ch_01_canonical.json: register clean (1 ban hit(s))
      U10 time_bands[2] 22–35 [clock] …, cry. What is it?' Pairs discuss their guesses in whispers for two minutes. Teacher invites guesses — students may suggest various thi…
...
PASS  ch_01_canonical.json: every question_type is a known assessment type (0 not)
      ADVISORY ch_01_canonical.json: ['FILL_IN', 'MATCH', 'MCQ', 'TRUE_FALSE', 'WRITING_TASK'] used by exactly one item in the whole library — check it against the constitution's type table
...
options arranged: 2 of 2 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ch_01_canonical.json: 2 of 2 item(s) re-ordered
          ...
          #3 None #3: A–D now hold 24351 · correct 3 -> 3
