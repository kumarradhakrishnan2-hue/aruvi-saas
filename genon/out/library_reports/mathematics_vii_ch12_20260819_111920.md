# Library certification · mathematics VII ch 12 · 20260819_111920

plan: counts [12, 10, 7] · basis authored_standard · registry 4 sections

FAIL  library complete: ['ch_12_canonical.json'] vs plan [12, 10, 7]
...
PASS  ch_12_canonical.json: every question_type is a known assessment type (0 not)
      ADVISORY ch_12_canonical.json: ['MCQ'] used by exactly one item in the whole library — check it against the constitution's type table
...
serve sweep: {"5": "fill/single -1s", "6": "fill/single -1s", "7": "fill/single", "8": "fill/single", "9": "fill/single", "10": "fill/single", "11": "synthesis", "12": "identity", "13": "surrender", "14": "surrender"}
