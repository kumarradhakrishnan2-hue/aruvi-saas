# Library certification · social_sciences VII ch 9 · 20260816_101637
...
FAIL  ch_09_canonical_p17.json: register clean (3 ban hit(s))
      ...
      U10 teacher_notes [forward] …ibed here and absolute monarchy, which will be the focus of the next unit.
      U11 time_bands[0] 0-8 [meta-leak] …quence. This links back to the separation-of-powers concept without naming a previous unit — the idea itself does the connecting.
      U14 time_bands[0] 0-8 [forward] …n. The teacher confirms the term — oligarchy — and says the unit will examine both its ancient and modern forms.
...
options arranged: 15 of 24 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ch_09_canonical.json: 0 of 8 item(s) re-ordered
      ch_09_canonical_p13.json: 8 of 8 item(s) re-ordered
          #1 C-4.1 U3: A–D now hold BCAD · correct A -> C
          #2 C-4.1 U6: A–D now hold DCAB · correct A -> C
          #6 C-8.1 U8: A–D now hold ACBD · correct A -> A
          #7 C-8.1 U12: A–D now hold CBDA · correct A -> D
          #9 C-4.2 U10: A–D now hold ACBD · correct A -> A
          #10 C-4.2 U12: A–D now hold ADCB · correct A -> A
          #12 C-5.1 U10: A–D now hold BDCA · correct A -> D
          #13 C-10.1 U8: A–D now hold CADB · correct A -> B
      ch_09_canonical_p17.json: 7 of 8 item(s) re-ordered
          #1 C-4.1 U1: A–D now hold BDCA · correct B -> A
          #2 C-4.1 U7: A–D now hold DACB · correct C -> C
          #6 C-8.1 U9: A–D now hold ADBC · correct B -> C
          #7 C-8.1 U15: A–D now hold BCAD · correct B -> A
          #10 C-5.1 U13: A–D now hold CDBA · correct C -> A
          #11 C-10.1 U9: A–D now hold BDCA · correct B -> A
          #12 C-10.1 U9: A–D now hold CDBA · correct C -> A
