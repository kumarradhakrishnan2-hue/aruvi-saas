# Library certification · social_sciences IX ch 6 · 20260812_185027
...
FAIL  ch_06_canonical_p15.json: register clean (2 ban hit(s))
      ...
      U6 teacher_notes [forward] …h can also spread misinformation — a tension the Challenges unit will develop. When students identify which principles media supports, pu…
      U15 time_bands[0] 0-12 [clock] …e 32 for Protective Mechanisms). Students work individually for eight minutes, then compare with a neighbour.
...
options arranged: 18 of 27 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ch_06_canonical.json: 0 of 9 item(s) re-ordered
      ch_06_canonical_p11.json: 9 of 9 item(s) re-ordered
          #1 C-5.4 U2: A–D now hold BCDA · correct B -> A
          #6 C-5.1 U1: A–D now hold BACD · correct B -> A
          #9 C-5.2 U2: A–D now hold DACB · correct B -> D
          #12 C-5.3 U2: A–D now hold ACDB · correct B -> D
          #14 C-5.5 U5: A–D now hold ACBD · correct B -> C
          #17 C-6.2 U4: A–D now hold ACDB · correct B -> D
          #20 C-6.4 U10: A–D now hold BDAC · correct B -> A
          #22 C-1.3 U1: A–D now hold CDBA · correct B -> C
          #24 C-2.5 U9: A–D now hold ACBD · correct B -> C
      ch_06_canonical_p15.json: 9 of 9 item(s) re-ordered
          #1 C-5.4 U7: A–D now hold BADC · correct B -> A
          #6 C-5.1 U1: A–D now hold DBAC · correct B -> B
          #9 C-5.2 U15: A–D now hold ADBC · correct B -> C
          #12 C-5.3 U3: A–D now hold CDBA · correct B -> C
          #14 C-5.5 U6: A–D now hold DACB · correct B -> D
          #17 C-6.2 U5: A–D now hold BADC · correct B -> A
          #20 C-6.4 U13: A–D now hold ADBC · correct B -> C
          #22 C-1.3 U1: A–D now hold ABDC · correct B -> B
          #24 C-2.5 U10: A–D now hold CDAB · correct B -> D
