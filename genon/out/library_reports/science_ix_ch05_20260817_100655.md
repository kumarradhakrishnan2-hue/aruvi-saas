# Library certification · science IX ch 5 · 20260817_100655
...
FAIL  ch_05_canonical.json: register clean (1 ban hit(s))
      ...
      U2 teacher_notes [forward] …prepares students to engage seriously with the formulae in the next unit.
...
options arranged: 5 of 5 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ch_05_canonical.json: 5 of 5 item(s) re-ordered
          #1 C-1.2 S1: A–D now hold CBDA · correct B -> B
          #2 C-1.2 S2: A–D now hold DBCA · correct B -> B
          #7 C-1.2 S7: A–D now hold DBAC · correct B -> B
          #8 C-1.2 S8: A–D now hold DCBA · correct C -> B
          #9 C-1.2 S9: A–D now hold CABD · correct B -> C
