# Library certification · mathematics VIII ch 4 · 20260819_133844
...
options arranged: 2 of 7 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ch_04_canonical.json: 0 of 3 item(s) re-ordered
      ch_04_canonical_p09.json: 2 of 2 item(s) re-ordered
          #1 None #1: A–D now hold CDBA · correct B -> C
          #2 None #2: A–D now hold CDAB · correct C -> A
