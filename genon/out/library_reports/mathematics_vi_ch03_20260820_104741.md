# Library certification · mathematics VI ch 3 · 20260820_104741

plan: counts [12, 10, 7] · basis authored_standard · registry 12 sections
...
PASS  ch_03_canonical.json: register scan reached the band text (49 band(s) read: {'activity_title': 12, 'materials': 19, 'teacher_notes': 12, 'time_bands': 49, 'homework': 4, 'visual_aids': 1})
FAIL  ch_03_canonical.json: register clean (1 ban hit(s))
      U12 teacher_notes [clock] …ce by writing them on the board. Students work individually for about fifteen minutes, showing full working. They then compare in groups of three…
      -> declare the fixes in genon/repair_register.py and re-run --certify-only; do NOT hand-edit the artefact
PASS  ch_03_canonical_p10.json: register scan reached the band text (35 band(s) read: {'activity_title': 10, 'materials': 20, 'teacher_notes': 10, 'time_bands': 35, 'homework': 3})
PASS  ch_03_canonical_p10.json: register clean (0 ban hit(s))
PASS  ch_03_canonical_p07.json: register scan reached the band text (25 band(s) read: {'activity_title': 7, 'materials': 27, 'teacher_notes': 7, 'time_bands': 25, 'homework': 2})
...
PASS  ch_03_canonical_p10.json: no stem points at a figure the item does not carry (0 does)
...
serve sweep: {"5": "fill/forward -3s", "6": "fill/backward -1s", "7": "identity", "8": "rescue/complete (from 10)", "9": "fill/forward", "10": "identity", "11": "fill/forward", "12": "identity", "13": "surrender", "14": "surrender"}
...
options arranged: 0 of 6 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ...
      ch_03_canonical_p07.json: 0 of 2 item(s) re-ordered
      ch_03_canonical_p10.json: 0 of 2 item(s) re-ordered
