# Library certification · the_world_around_us III ch 2 · 20260812_145758
...
PASS  ch_02_canonical_p09.json: every handoff row routes to a unit that anchors its section
      ...
      ADVISORY ch_02_canonical_p09.json: 9 unit(s) wear a section label the handoff does not route items through: U1=preparing for the mela, U2=on the way to the mela, U3=on the way to the mela, U4=at the mela, U5=at the mela, U6=at the mela …  (do NOT extend period_numbers to fix this — it moves the item to a later unit and loses it on short serves)
PASS  ch_02_canonical_p07.json: every handoff row routes to a unit that anchors its section
      ...
      ADVISORY ch_02_canonical_p07.json: 7 unit(s) wear a section label the handoff does not route items through: U1=preparing for the mela, U2=on the way to the mela, U3=at the mela, U4=at the mela, U5=at the mela, U6=let us reflect …  (do NOT extend period_numbers to fix this — it moves the item to a later unit and loses it on short serves)
...
PASS  ch_02_canonical_p09.json: register scan reached the band text (45 band(s) read: {'activity_title': 9, 'materials': 31, 'teacher_facilitation_note': 9, 'time_bands': 45, 'visual_aids': 6})
PASS  ch_02_canonical_p09.json: register clean (0 ban hit(s))
PASS  ch_02_canonical_p07.json: register scan reached the band text (28 band(s) read: {'activity_title': 7, 'materials': 20, 'teacher_facilitation_note': 7, 'time_bands': 28, 'visual_aids': 5})
...
item counts per competency — ADVISORY, does not gate; basis: derived (modal count across this library — no constitution row yet)
      ...
      ch_02_canonical_p09.json: 9 items vs 9 expected
...
serve sweep: {"5": "fill/single", "6": "fill/single", "7": "identity", "8": "fill/single", "9": "identity", "10": "synthesis", "11": "identity", "12": "surrender", "13": "surrender"}
...
options arranged: 6 of 11 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ...
      ch_02_canonical_p07.json: 3 of 3 item(s) re-ordered
          #1 C-4.7 U1: A–D now hold CBAD · correct A -> C
          #3 C-1.4 U3: A–D now hold BADC · correct A -> B
          #6 C-1.4 U6: A–D now hold ADCB · correct A -> A
      ch_02_canonical_p09.json: 3 of 4 item(s) re-ordered
          #1 C-4.7 U1: A–D now hold BCDA · correct B -> A
          #5 C-5.1 U5: A–D now hold CABD · correct B -> C
          #8 C-1.4 U8: A–D now hold ACDB · correct C -> B
