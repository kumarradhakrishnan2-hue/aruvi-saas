# Library certification · social_sciences VIII ch 15 · 20260816_094444

plan: counts [17, 14, 10] · basis authored_standard · registry 16 sections

FAIL  library complete: ['ch_15_canonical.json'] vs plan [17, 14, 10]
...
PASS  ch_15_canonical.json: every question_type is a known assessment type (0 not)
      ADVISORY ch_15_canonical.json: ['ECR', 'OPEN_TASK'] used by exactly one item in the whole library — check it against the constitution's type table
