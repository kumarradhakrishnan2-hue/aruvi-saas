# Library certification · mathematics VIII ch 14 · 20260819_111423

plan: counts [14, 11, 8] · basis authored_standard · registry 7 sections

FAIL  library complete: ['ch_14_canonical.json'] vs plan [14, 11, 8]
...
PASS  ch_14_canonical.json: register scan reached the band text (56 band(s) read: {'activity_title': 14, 'materials': 50, 'teacher_notes': 14, 'time_bands': 56, 'homework': 4})
FAIL  ch_14_canonical.json: register clean (1 ban hit(s))
      U11 teacher_notes [forward] …t composite figure set for independent work is a deliberate bridge to the measurement-and-conversion theme of the real-life section.
...
serve sweep: {"6": "fill/single -4s", "7": "fill/single -3s", "8": "fill/single -2s", "9": "fill/single -2s", "10": "fill/single -1s", "11": "fill/single", "12": "fill/single", "13": "synthesis", "14": "identity", "15": "surrender", "16": "surrender"}
...
options arranged: 3 of 3 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ch_14_canonical.json: 3 of 3 item(s) re-ordered
          #1 None #1: A–D now hold DBCA · correct B -> B
          #6 None #6: A–D now hold CBAD · correct B -> B
          #9 None #9: A–D now hold DBCA · correct B -> B
