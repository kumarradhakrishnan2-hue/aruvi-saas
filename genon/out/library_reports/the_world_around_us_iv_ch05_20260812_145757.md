# Library certification · the_world_around_us IV ch 5 · 20260812_145757
...
PASS  ch_05_canonical.json: every handoff row routes to a unit that anchors its section
      ...
      ADVISORY ch_05_canonical.json: 12 unit(s) wear a section label the handoff does not route items through: U1=mystery masala, U2=mystery masala, U3=a stall of 'super food', U4=how does food help us?, U5=how does food help us?, U6=say 'no' to junk food …  (do NOT extend period_numbers to fix this — it moves the item to a later unit and loses it on short serves)
PASS  ch_05_canonical_p11.json: every handoff row routes to a unit that anchors its section
      ...
      ADVISORY ch_05_canonical_p11.json: 11 unit(s) wear a section label the handoff does not route items through: U1=mystery masala, U2=mystery masala, U3=a stall of 'super food', U4=how does food help us?, U5=how does food help us?, U6=say 'no' to junk food …  (do NOT extend period_numbers to fix this — it moves the item to a later unit and loses it on short serves)
PASS  ch_05_canonical_p08.json: every handoff row routes to a unit that anchors its section
      ...
      ADVISORY ch_05_canonical_p08.json: 8 unit(s) wear a section label the handoff does not route items through: U1=mystery masala, U2=a stall of 'super food', U3=how does food help us?, U4=say 'no' to junk food, U5=a balanced food plate, U6=water for health …  (do NOT extend period_numbers to fix this — it moves the item to a later unit and loses it on short serves)
PASS  ch_05_canonical.json: register scan reached the band text (64 band(s) read: {'activity_title': 13, 'materials': 47, 'visual_aids': 10, 'teacher_facilitation_note': 13, 'time_bands': 64})
PASS  ch_05_canonical.json: register clean (0 ban hit(s))
PASS  ch_05_canonical_p11.json: register scan reached the band text (54 band(s) read: {'activity_title': 11, 'materials': 40, 'visual_aids': 8, 'teacher_facilitation_note': 11, 'time_bands': 54})
PASS  ch_05_canonical_p11.json: register clean (0 ban hit(s))
PASS  ch_05_canonical_p08.json: register scan reached the band text (32 band(s) read: {'activity_title': 8, 'materials': 28, 'visual_aids': 7, 'teacher_facilitation_note': 8, 'time_bands': 32})
...
item counts per competency — ADVISORY, does not gate; basis: derived (modal count across this library — no constitution row yet)
      ...
      ch_05_canonical_p11.json: 11 items vs 11 expected
...
options arranged: 5 of 9 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ...
      ch_05_canonical_p08.json: 2 of 2 item(s) re-ordered
          #1 C-4.2 U1: A–D now hold DACB · correct A -> B
          #6 C-2.1 U6: A–D now hold CABD · correct B -> C
      ch_05_canonical_p11.json: 3 of 3 item(s) re-ordered
          #1 C-4.2 U1: A–D now hold ADBC · correct C -> D
          #4 C-2.1 U4: A–D now hold BADC · correct B -> A
          #8 C-2.1 U8: A–D now hold DBCA · correct C -> C
