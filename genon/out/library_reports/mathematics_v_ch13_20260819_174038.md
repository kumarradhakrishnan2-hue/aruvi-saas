# Library certification · mathematics V ch 13 · 20260819_174038

plan: counts [8, 5] · basis authored_standard · registry 4 sections

FAIL  library complete: ['ch_13_canonical.json'] vs plan [8, 5]
...
serve sweep: {"3": "fill/single -1s", "4": "fill/single -1s", "5": "fill/single", "6": "fill/single", "7": "fill/single", "8": "identity", "9": "surrender", "10": "surrender"}
...
options arranged: 4 of 6 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ch_13_canonical.json: 4 of 6 item(s) re-ordered
          #2 None #2: A–D now hold BADC · correct B -> A
