# Library certification · mathematics VIII ch 12 · 20260819_133848
...
PASS  ch_12_canonical.json: register scan reached the band text (64 band(s) read: {'activity_title': 16, 'materials': 49, 'teacher_notes': 16, 'time_bands': 64, 'homework': 2})
...
FAIL  ch_12_canonical_p13.json: every non-OPEN_TASK item carries a stem (1 without)
      Q-C-10: MCQ has prompt '' — there is nothing to ask
...
options arranged: 4 of 8 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ...
      ch_12_canonical_p10.json: 2 of 2 item(s) re-ordered
          #1 None #1: A–D now hold DABC · correct B -> C
          #10 None #10: A–D now hold ABDC · correct B -> B
      ch_12_canonical_p13.json: 2 of 3 item(s) re-ordered
          #8 None #8: A–D now hold CABD · correct C -> A
          #10 None #10: A–D now hold DABC · correct C -> D
QUARANTINED  ch_12_canonical_p13.json -> backup/quarantine/mathematics/viii/ch_12_canonical_p13_20260819_133848.json
