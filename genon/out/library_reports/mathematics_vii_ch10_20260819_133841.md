# Library certification · mathematics VII ch 10 · 20260819_133841
...
PASS  ch_10_canonical.json: register scan reached the band text (48 band(s) read: {'activity_title': 12, 'materials': 17, 'teacher_notes': 12, 'time_bands': 48})
...
FAIL  ch_10_canonical_p07.json: register clean (1 ban hit(s))
      U3 teacher_notes [forward] …tudents who want to see the rule applied numerically before the next unit.
...
options arranged: 2 of 4 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ...
      ch_10_canonical_p07.json: 1 of 1 item(s) re-ordered
          #1 None #1: A–D now hold DABC · correct B -> C
      ch_10_canonical_p10.json: 1 of 1 item(s) re-ordered
