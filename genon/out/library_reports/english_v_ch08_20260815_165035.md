# Library certification · english V ch 8 · 20260815_165035
...
PASS  ch_08_canonical.json: every question_type is a known assessment type (0 not)
      ADVISORY ch_08_canonical.json: ['WRITING_TASK'] used by exactly one item in the whole library — check it against the constitution's type table
...
serve sweep: {"6": "fill/single -2s", "7": "fill/single -1s", "8": "fill/single -1s", "9": "fill/single -1s", "10": "fill/single", "11": "fill/single", "12": "synthesis", "13": "synthesis", "14": "identity", "15": "surrender", "16": "surrender"}
