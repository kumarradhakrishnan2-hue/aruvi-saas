# Library certification · the_world_around_us V ch 9 · 20260812_141622

plan: counts [12, 10, 7] · basis authored_standard · registry 4 sections

FAIL  library complete: ['ch_09_canonical.json'] vs plan [12, 10, 7]
...
FAIL  ch_09_canonical.json: register clean (1 ban hit(s))
      U3 teacher_facilitation_note [forward] …re, what is happening on the other side of the Earth?' This bridges to the globe task on Textbook p. 151 and keeps the inquiry open. C…
...
serve sweep: {"5": "fill/single -1s", "6": "fill/single", "7": "fill/single", "8": "fill/single", "9": "synthesis", "10": "synthesis", "11": "synthesis", "12": "identity", "13": "surrender", "14": "surrender"}
...
options arranged: 2 of 2 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ch_09_canonical.json: 2 of 2 item(s) re-ordered
          #1 C-1.3 U1: A–D now hold ADBC · correct B -> C
          #4 C-7.2 U4: A–D now hold BDAC · correct B -> A
