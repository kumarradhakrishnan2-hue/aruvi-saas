# Library certification · english III ch 8 · 20260815_165029

plan: counts [11, 9, 7] · basis authored_standard · registry 5 sections

FAIL  library complete: ['ch_08_canonical.json'] vs plan [11, 9, 7]
...
FAIL  ch_08_canonical.json: register clean (1 ban hit(s))
      U4 time_bands[4] 38–40 [forward] …colours the poem mentions and children call them out. This bridges to the word-work activity on colour words.
...
PASS  ch_08_canonical.json: every question_type is a known assessment type (0 not)
      ADVISORY ch_08_canonical.json: ['FILL_IN', 'MCQ', 'SCR', 'TRUE_FALSE', 'WRITING_TASK'] used by exactly one item in the whole library — check it against the constitution's type table
...
serve sweep: {"5": "fill/single -2s", "6": "fill/single -1s", "7": "fill/single -1s", "8": "fill/single -1s", "9": "fill/single", "10": "fill/single", "11": "identity", "12": "surrender", "13": "surrender"}
...
options arranged: 2 of 2 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ch_08_canonical.json: 2 of 2 item(s) re-ordered
          #1 None #1: A–D now hold 2431 · correct 2 -> 1
