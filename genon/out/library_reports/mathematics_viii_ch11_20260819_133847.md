# Library certification · mathematics VIII ch 11 · 20260819_133847
...
FAIL  ch_11_canonical_p14.json: register clean (1 ban hit(s))
      U1 time_bands[2] 25–38 [forward] …mountains) from mathematical fractals (to be constructed in later units). Groups explain in one sentence why a straight line or a s…
...
options arranged: 5 of 9 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ...
      ch_11_canonical_p10.json: 2 of 2 item(s) re-ordered
          #1 None #1: A–D now hold ADBC · correct A -> A
          #2 None #2: A–D now hold DBAC · correct B -> B
      ch_11_canonical_p14.json: 3 of 3 item(s) re-ordered
          #1 None #1: A–D now hold BCAD · correct B -> A
          #2 None #2: A–D now hold ACBD · correct B -> C
          #3 None #3: A–D now hold ACDB · correct C -> B
