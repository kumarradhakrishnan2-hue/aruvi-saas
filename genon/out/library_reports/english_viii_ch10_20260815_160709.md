# Library certification · english VIII ch 10 · 20260815_160709
...
PASS  ch_10_canonical.json: register scan reached the band text (39 band(s) read: {'activity_title': 10, 'materials': 14, 'teacher_notes': 10, 'time_bands': 39, 'homework': 1})
PASS  ch_10_canonical.json: register clean (0 ban hit(s))
PASS  ch_10_canonical_p08.json: register scan reached the band text (25 band(s) read: {'activity_title': 8, 'materials': 11, 'teacher_notes': 8, 'time_bands': 25, 'homework': 2})
FAIL  ch_10_canonical_p08.json: register clean (1 ban hit(s))
      U5 time_bands[0] 0–10 [clock] …who, why, how, and message. Pairs share any prior knowledge for two minutes.
      -> declare the fixes in genon/repair_register.py and re-run --certify-only; do NOT hand-edit the artefact
PASS  ch_10_canonical_p06.json: register scan reached the band text (22 band(s) read: {'activity_title': 6, 'materials': 14, 'teacher_notes': 6, 'time_bands': 22, 'homework': 2})
PASS  ch_10_canonical_p06.json: register clean (0 ban hit(s))
      ADVISORY ch_10_canonical_p06.json: 1 artefact-dependency hit(s) — a unit reaching for something a PREVIOUS sitting produced. Read them: the brief forbids it, certification cannot.
        U6 teacher_notes: 'prepared in advance' — …Bahuguna, Medha Patkar, Vandana Shiva, Tulsi Gowda) can be prepared in advance to support students who have no access to independent refer…
...
options arranged: 4 of 6 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ...
      ch_10_canonical_p08.json: 3 of 3 item(s) re-ordered
          ...
          #5 None #5: A–D now hold 4321 · correct 4 -> 1
