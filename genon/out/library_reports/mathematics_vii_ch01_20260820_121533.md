# Library certification · mathematics VII ch 1 · 20260820_121533
...
PASS  ch_01_canonical.json: register scan reached the band text (45 band(s) read: {'activity_title': 11, 'materials': 22, 'teacher_notes': 11, 'time_bands': 45, 'homework': 7, 'visual_aids': 1})
FAIL  ch_01_canonical.json: register clean (2 ban hit(s))
      U11 teacher_notes [clock] …without written steps. Groups of three then compare working for 8 minutes; any disagreement must be reconstructed step by step, not r…
      U11 teacher_notes [clock] …on the board. Students work individually with full working for the first 15 minutes — do not accept answers without written steps. Groups of th…
      -> declare the fixes in genon/repair_register.py and re-run --certify-only; do NOT hand-edit the artefact
PASS  ch_01_canonical_p09.json: register scan reached the band text (36 band(s) read: {'activity_title': 9, 'materials': 19, 'teacher_notes': 9, 'time_bands': 36, 'homework': 3})
PASS  ch_01_canonical_p09.json: register clean (0 ban hit(s))
PASS  ch_01_canonical_p07.json: register scan reached the band text (28 band(s) read: {'activity_title': 7, 'materials': 15, 'teacher_notes': 7, 'time_bands': 28, 'homework': 4})
...
PASS  ch_01_canonical_p09.json: no stem points at a figure the item does not carry (0 does)
...
options arranged: 0 of 5 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ...
      ch_01_canonical_p09.json: 0 of 2 item(s) re-ordered
