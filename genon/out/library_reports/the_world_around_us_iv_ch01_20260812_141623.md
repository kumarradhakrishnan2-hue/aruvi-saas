# Library certification · the_world_around_us IV ch 1 · 20260812_141623
...
serve sweep: {"4": "fill/single -3s", "5": "fill/single -2s", "6": "fill/single -2s", "7": "fill/single -1s", "8": "fill/single", "9": "synthesis", "10": "identity", "11": "surrender", "12": "surrender"}
...
options arranged: 2 of 3 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ch_01_canonical.json: 2 of 3 item(s) re-ordered
          #1 C-1.4 U1: A–D now hold ADCB · correct B -> D
          #4 C-4.7 U4: A–D now hold CDBA · correct C -> A
