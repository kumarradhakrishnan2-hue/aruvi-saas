# Library certification · english VI ch 1 · 20260815_160700
...
PASS  ch_01_canonical.json: register scan reached the band text (30 band(s) read: {'activity_title': 8, 'materials': 9, 'teacher_notes': 8, 'time_bands': 30, 'homework': 2})
FAIL  ch_01_canonical.json: register clean (1 ban hit(s))
      U6 time_bands[3] 38–40 [forward] …. The exercise demonstrates how sound precision matters — a bridge to the phonics work from the speaking unit.
      -> declare the fixes in genon/repair_register.py and re-run --certify-only; do NOT hand-edit the artefact
PASS  ch_01_canonical_p05.json: register scan reached the band text (17 band(s) read: {'activity_title': 5, 'materials': 13, 'teacher_notes': 5, 'time_bands': 17, 'homework': 2})
...
PASS  ch_01_canonical.json: every question_type is a known assessment type (0 not)
      ADVISORY ch_01_canonical.json: ['TRUE_FALSE'] used by exactly one item in the whole library — check it against the constitution's type table
