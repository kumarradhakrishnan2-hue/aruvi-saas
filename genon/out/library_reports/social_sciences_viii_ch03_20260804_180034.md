# Library certification · social_sciences VIII ch 3 · 20260804_180034
...
options arranged: 0 of 41 item(s) re-ordered this run; 41 of 41 were re-ordered when this library was first normalized — the generation-quality rate for Rule 7 (ARV-D-032). A 0 with no earlier run behind it means the model arranged them unaided.
      ch_03_canonical.json: 0 of 14 item(s) re-ordered (this run; 14 moved by an earlier run)
      ch_03_canonical_p10.json: 0 of 14 item(s) re-ordered (this run; 14 moved by an earlier run)
      ch_03_canonical_p13.json: 0 of 13 item(s) re-ordered (this run; 13 moved by an earlier run)
