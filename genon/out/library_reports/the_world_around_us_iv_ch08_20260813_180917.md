# Library certification · the_world_around_us IV ch 8 · 20260813_180917
...
PASS  ch_08_canonical_p11.json: every handoff row routes to a unit that anchors its section
      ...
      ADVISORY ch_08_canonical_p11.json: 11 unit(s) wear a section label the handoff does not route items through: U1=how paper is made, U2=how paper is made, U3=how paper is made, U4=how paper is made, U5=making responsible choices, U6=making responsible choices …  (do NOT extend period_numbers to fix this — it moves the item to a later unit and loses it on short serves)
...
PASS  ch_08_canonical_p08.json: register clean (0 ban hit(s))
      ADVISORY ch_08_canonical_p08.json: 1 artefact-dependency hit(s) — a unit reaching for something a PREVIOUS sitting produced. Read them: the brief forbids it, certification cannot.
        U2 time_bands[0] 0-6: 'prepared beforehand' — …r shows children the soaked newspaper-and-fenugreek mixture prepared beforehand and briefly explains the process visible on Textbook p. 119…
...
serve sweep: {"6": "fill/single -2s", "7": "fill/single -1s", "8": "identity", "9": "fill/single", "10": "fill/single", "11": "identity", "12": "fill/single", "13": "identity", "14": "surrender", "15": "surrender"}
...
options arranged: 0 of 9 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ...
      ch_08_canonical_p11.json: 0 of 2 item(s) re-ordered
