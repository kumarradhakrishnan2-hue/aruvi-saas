# Library certification · english IV ch 7 · 20260815_183409
...
PASS  ch_07_canonical.json: register scan reached the band text (45 band(s) read: {'activity_title': 11, 'materials': 32, 'teacher_notes': 11, 'time_bands': 45, 'homework': 1})
PASS  ch_07_canonical.json: register clean (0 ban hit(s))
PASS  ch_07_canonical_p09.json: register scan reached the band text (36 band(s) read: {'activity_title': 9, 'materials': 22, 'teacher_notes': 9, 'time_bands': 36, 'homework': 1})
PASS  ch_07_canonical_p09.json: register clean (0 ban hit(s))
PASS  ch_07_canonical_p07.json: register scan reached the band text (29 band(s) read: {'activity_title': 7, 'materials': 17, 'teacher_notes': 7, 'time_bands': 29, 'homework': 1})
...
options arranged: 3 of 6 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ...
      ch_07_canonical_p09.json: 1 of 2 item(s) re-ordered
