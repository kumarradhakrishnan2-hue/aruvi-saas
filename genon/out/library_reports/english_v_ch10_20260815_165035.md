# Library certification · english V ch 10 · 20260815_165035
...
FAIL  ch_10_canonical.json: register clean (1 ban hit(s))
      U1 teacher_notes [forward] …reading aloud is the priority — comprehension tasks come in the next unit. Watch for mispronunciation of 'Firozabad' and 'geometric';…
...
PASS  ch_10_canonical.json: every question_type is a known assessment type (0 not)
      ADVISORY ch_10_canonical.json: ['ORAL_PROMPT', 'PROJECT', 'TRUE_FALSE', 'WRITING_TASK'] used by exactly one item in the whole library — check it against the constitution's type table
...
serve sweep: {"5": "fill/single -2s", "6": "fill/single -2s", "7": "fill/single -1s", "8": "fill/single -1s", "9": "fill/single -1s", "10": "fill/single", "11": "identity", "12": "surrender", "13": "surrender"}
...
options arranged: 3 of 3 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ch_10_canonical.json: 3 of 3 item(s) re-ordered
          ...
          #3 None #3: A–D now hold 231 · correct 3 -> 2
