# Library certification · mathematics VII ch 3 · 20260820_104745
...
PASS  ch_03_canonical.json: register scan reached the band text (37 band(s) read: {'activity_title': 9, 'materials': 23, 'teacher_notes': 9, 'time_bands': 37, 'homework': 3, 'visual_aids': 1})
FAIL  ch_03_canonical.json: register clean (1 ban hit(s))
      U9 teacher_notes [clock] …ogether on the board. Students work individually in silence for the first fifteen minutes, writing full working in their exercise books. Groups of th…
      -> declare the fixes in genon/repair_register.py and re-run --certify-only; do NOT hand-edit the artefact
PASS  ch_03_canonical_p07.json: register scan reached the band text (24 band(s) read: {'activity_title': 7, 'materials': 17, 'teacher_notes': 7, 'time_bands': 24, 'homework': 4})
PASS  ch_03_canonical_p07.json: register clean (0 ban hit(s))
PASS  ch_03_canonical_p05.json: register scan reached the band text (20 band(s) read: {'activity_title': 5, 'materials': 15, 'teacher_notes': 5, 'time_bands': 20, 'homework': 4})
...
PASS  ch_03_canonical_p05.json: no stem points at a figure the item does not carry (0 does)
...
item counts per competency — ADVISORY, does not gate; basis: derived (modal count across this library — no constitution row yet)
      ...
      ch_03_canonical_p05.json: 0 items vs 0 expected
...
serve sweep: {"3": "fill/forward -3s", "4": "fill/backward -1s", "5": "identity", "6": "rescue/complete (from 7)", "7": "identity", "8": "fill/backward", "9": "identity", "10": "surrender", "11": "surrender"}
...
options arranged: 0 of 7 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ...
      ch_03_canonical_p05.json: 0 of 1 item(s) re-ordered
      ch_03_canonical_p07.json: 0 of 3 item(s) re-ordered
