# Library certification · english VII ch 5 · 20260815_160704
...
PASS  ch_05_canonical.json: register scan reached the band text (35 band(s) read: {'activity_title': 12, 'materials': 21, 'teacher_notes': 12, 'time_bands': 35, 'homework': 2})
PASS  ch_05_canonical.json: register clean (0 ban hit(s))
PASS  ch_05_canonical_p10.json: register scan reached the band text (36 band(s) read: {'activity_title': 10, 'materials': 17, 'teacher_notes': 10, 'time_bands': 36, 'homework': 3})
PASS  ch_05_canonical_p10.json: register clean (0 ban hit(s))
PASS  ch_05_canonical_p07.json: register scan reached the band text (23 band(s) read: {'activity_title': 7, 'materials': 12, 'teacher_notes': 7, 'time_bands': 23, 'homework': 2})
...
PASS  ch_05_canonical.json: every question_type is a known assessment type (0 not)
      ADVISORY ch_05_canonical.json: ['TRUE_FALSE'] used by exactly one item in the whole library — check it against the constitution's type table
...
options arranged: 4 of 6 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ...
      ch_05_canonical_p07.json: 2 of 2 item(s) re-ordered
          ...
          #3 None #3: A–D now hold BCDA · correct B -> A
      ch_05_canonical_p10.json: 2 of 2 item(s) re-ordered
