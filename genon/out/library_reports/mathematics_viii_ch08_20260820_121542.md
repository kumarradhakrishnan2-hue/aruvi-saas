# Library certification · mathematics VIII ch 8 · 20260820_121542

plan: counts [14, 11, 8] · basis authored_standard · registry 3 sections

PASS  library complete: ['ch_08_canonical.json', 'ch_08_canonical_p11.json', 'ch_08_canonical_p08.json'] vs plan [14, 11, 8]
...
PASS  ch_08_canonical.json: register scan reached the band text (57 band(s) read: {'activity_title': 14, 'materials': 33, 'teacher_notes': 14, 'time_bands': 57, 'homework': 9, 'visual_aids': 1})
FAIL  ch_08_canonical.json: register clean (1 ban hit(s))
      U14 teacher_notes [clock] …nd let students work individually with full written working for the first fifteen minutes — no answers shared yet. Then small groups of three compare…
      -> declare the fixes in genon/repair_register.py and re-run --certify-only; do NOT hand-edit the artefact
PASS  ch_08_canonical_p11.json: register scan reached the band text (55 band(s) read: {'activity_title': 11, 'materials': 33, 'teacher_notes': 11, 'time_bands': 55, 'homework': 9})
PASS  ch_08_canonical_p11.json: register clean (0 ban hit(s))
PASS  ch_08_canonical_p08.json: register scan reached the band text (32 band(s) read: {'activity_title': 8, 'materials': 21, 'teacher_notes': 8, 'time_bands': 32, 'homework': 7})
...
PASS  ch_08_canonical_p11.json: no stem points at a figure the item does not carry (0 does)
PASS  ch_08_canonical_p08.json: no stem points at a figure the item does not carry (0 does)
...
item counts per competency — ADVISORY, does not gate; basis: derived (modal count across this library — no constitution row yet)
      ...
      ch_08_canonical_p11.json: 0 items vs 0 expected
      ch_08_canonical_p08.json: 0 items vs 0 expected
...
options arranged: 0 of 6 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ...
      ch_08_canonical_p08.json: 0 of 2 item(s) re-ordered
