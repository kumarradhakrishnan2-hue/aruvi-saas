# Library certification · english IX ch 9 · 20260814_135117
...
PASS  ch_09_canonical.json: register scan reached the band text (36 band(s) read: {'activity_title': 11, 'materials': 16, 'teacher_notes': 11, 'time_bands': 36, 'homework': 1})
PASS  ch_09_canonical.json: register clean (0 ban hit(s))
PASS  ch_09_canonical_p09.json: register scan reached the band text (37 band(s) read: {'activity_title': 9, 'materials': 25, 'teacher_notes': 9, 'time_bands': 37, 'homework': 1})
FAIL  ch_09_canonical_p09.json: register clean (1 ban hit(s))
      U2 teacher_notes [forward] …nts are now well placed to distinguish fact from opinion in the next unit.
      -> declare the fixes in genon/repair_register.py and re-run --certify-only; do NOT hand-edit the artefact
PASS  ch_09_canonical_p07.json: register scan reached the band text (29 band(s) read: {'activity_title': 7, 'materials': 11, 'teacher_notes': 7, 'time_bands': 29, 'homework': 2})
...
serve sweep: {"5": "fill/forward -2s", "6": "fill/forward", "7": "identity", "8": "rescue/complete (from 9)", "9": "identity", "10": "fill/forward", "11": "identity", "12": "surrender", "13": "surrender"}
...
options arranged: 3 of 5 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ...
      ch_09_canonical_p07.json: 1 of 1 item(s) re-ordered
          #3 None #3: A–D now hold BDAC · correct B -> A
      ch_09_canonical_p09.json: 2 of 2 item(s) re-ordered
