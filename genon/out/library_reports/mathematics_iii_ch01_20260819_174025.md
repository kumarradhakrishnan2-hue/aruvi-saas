# Library certification · mathematics III ch 1 · 20260819_174025

plan: counts [7, 4] · basis authored_standard · registry 4 sections

FAIL  library complete: ['ch_01_canonical.json'] vs plan [7, 4]
...
FAIL  ch_01_canonical.json: register clean (1 ban hit(s))
      U3 teacher_notes [forward] …shorter or longer names, setting up the reasoning tasks in the next unit.
...
serve sweep: {"2": "fill/single -2s", "3": "fill/single -1s", "4": "fill/single", "5": "fill/single", "6": "fill/single", "7": "identity", "8": "surrender", "9": "surrender"}
...
options arranged: 4 of 5 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ch_01_canonical.json: 4 of 5 item(s) re-ordered
          #2 None #2: A–D now hold CDBA · correct A -> D
          #4 None #4: A–D now hold DBCA · correct A -> D
          #6 None #6: A–D now hold ACBD · correct D -> D
