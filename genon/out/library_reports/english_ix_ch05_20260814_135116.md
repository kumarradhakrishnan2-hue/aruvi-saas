# Library certification · english IX ch 5 · 20260814_135116
...
FAIL  ch_05_canonical_p06.json: register clean (1 ban hit(s))
      U6 time_bands[3] 35–50 [clock] …their chosen craft and note the first three headings within the remaining time, establishing a working plan they can develop independently…
...
options arranged: 3 of 6 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ...
      ch_05_canonical_p06.json: 1 of 2 item(s) re-ordered
          #1 None #1: A–D now hold 3421 · correct 3 -> 1
