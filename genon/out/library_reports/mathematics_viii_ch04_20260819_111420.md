# Library certification · mathematics VIII ch 4 · 20260819_111420
...
PASS  ch_04_canonical.json: register scan reached the band text (60 band(s) read: {'activity_title': 15, 'materials': 75, 'teacher_notes': 15, 'time_bands': 60, 'homework': 3})
...
serve sweep: {"7": "fill/single -2s", "8": "fill/single -2s", "9": "fill/single -1s", "10": "fill/single", "11": "synthesis", "12": "synthesis", "13": "synthesis", "14": "synthesis", "15": "identity", "16": "surrender", "17": "surrender"}

options arranged: 1 of 3 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ch_04_canonical.json: 1 of 3 item(s) re-ordered
          #3 None #3: A–D now hold DCAB · correct B -> D
