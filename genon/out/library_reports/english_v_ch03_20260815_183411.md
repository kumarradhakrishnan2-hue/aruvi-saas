# Library certification · english V ch 3 · 20260815_183411
...
PASS  ch_03_canonical.json: register scan reached the band text (64 band(s) read: {'activity_title': 16, 'materials': 35, 'teacher_notes': 16, 'time_bands': 64})
PASS  ch_03_canonical.json: register clean (0 ban hit(s))
PASS  ch_03_canonical_p13.json: register scan reached the band text (52 band(s) read: {'activity_title': 13, 'materials': 31, 'teacher_notes': 13, 'time_bands': 52, 'homework': 4})
FAIL  ch_03_canonical_p13.json: register clean (3 ban hit(s))
      U1 teacher_notes [forward] …irely about sound and feel; comprehension tasks follow in a later unit. The poem's anaphoric ‘But’ at the start of lines 3 and 6 i…
      U3 time_bands[2] 18–32 [clock] …ould walk on a rainbow, where would it take you? Pairs talk for a few minutes; then each pair shares one idea with the class. Teacher not…
      U13 time_bands[1] 8–28 [clock] …atural things (clouds, rainbows). Each group talks together for five minutes, then a spokesperson from each shares the group’s ideas wit…
      -> declare the fixes in genon/repair_register.py and re-run --certify-only; do NOT hand-edit the artefact
PASS  ch_03_canonical_p10.json: register scan reached the band text (40 band(s) read: {'activity_title': 10, 'materials': 16, 'teacher_notes': 10, 'time_bands': 40, 'homework': 2})
...
item counts per competency — ADVISORY, does not gate; basis: derived (modal count across this library — no constitution row yet)
      ...
      ch_03_canonical_p13.json: 0 items vs 0 expected
...
serve sweep: {"8": "fill/single -1s", "9": "fill/single", "10": "identity", "11": "fill/single", "12": "fill/single", "13": "identity", "14": "fill/single", "15": "synthesis", "16": "identity", "17": "surrender", "18": "surrender"}
...
options arranged: 5 of 7 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ...
      ch_03_canonical_p13.json: 2 of 2 item(s) re-ordered
          #1 None #1: A–D now hold CDBA · correct B -> C
          #3 None #3: A–D now hold 2143 · correct 1 -> 2
