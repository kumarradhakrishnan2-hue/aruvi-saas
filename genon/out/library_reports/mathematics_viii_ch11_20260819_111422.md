# Library certification · mathematics VIII ch 11 · 20260819_111422
...
PASS  ch_11_canonical.json: register scan reached the band text (66 band(s) read: {'activity_title': 17, 'materials': 60, 'teacher_notes': 17, 'time_bands': 66, 'homework': 3})
FAIL  ch_11_canonical.json: register clean (1 ban hit(s))
      U15 teacher_notes [forward] …hexagon in the isometric orientation is a natural bridge to the next unit's topic; do not over-explain it here, but mark it as a resu…
...
PASS  ch_11_canonical.json: every question_type is a known assessment type (0 not)
      ADVISORY ch_11_canonical.json: ['ECR'] used by exactly one item in the whole library — check it against the constitution's type table
...
serve sweep: {"8": "fill/single -5s", "9": "fill/single -4s", "10": "fill/single -4s", "11": "fill/single -4s", "12": "fill/single -3s", "13": "fill/single -2s", "14": "fill/single -2s", "15": "fill/forward", "16": "fill/forward", "17": "identity", "18": "surrender", "19": "surrender"}
...
options arranged: 4 of 4 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ch_11_canonical.json: 4 of 4 item(s) re-ordered
          #1 None #1: A–D now hold DABC · correct A -> B
          #2 None #2: A–D now hold DBCA · correct A -> D
