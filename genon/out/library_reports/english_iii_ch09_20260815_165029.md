# Library certification · english III ch 9 · 20260815_165029

plan: counts [9, 7, 5] · basis authored_standard · registry 5 sections

FAIL  library complete: ['ch_09_canonical.json'] vs plan [9, 7, 5]
...
PASS  ch_09_canonical.json: every question_type is a known assessment type (0 not)
      ADVISORY ch_09_canonical.json: ['FILL_IN', 'MATCH', 'SCR', 'TRUE_FALSE', 'WRITING_TASK'] used by exactly one item in the whole library — check it against the constitution's type table
...
serve sweep: {"3": "fill/single -3s", "4": "fill/single -2s", "5": "fill/single -2s", "6": "fill/single -1s", "7": "fill/single -1s", "8": "fill/single", "9": "identity", "10": "surrender", "11": "surrender"}
...
options arranged: 2 of 3 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ch_09_canonical.json: 2 of 3 item(s) re-ordered
          #1 None #1: A–D now hold 4321 · correct 4 -> 1
          #5 None #5: A–D now hold CDBA · correct B -> C
