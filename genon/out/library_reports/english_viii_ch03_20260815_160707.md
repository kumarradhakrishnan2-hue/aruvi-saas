# Library certification · english VIII ch 3 · 20260815_160707
...
PASS  ch_03_canonical.json: register scan reached the band text (27 band(s) read: {'activity_title': 8, 'materials': 14, 'teacher_notes': 8, 'time_bands': 27, 'homework': 2})
PASS  ch_03_canonical.json: register clean (0 ban hit(s))
PASS  ch_03_canonical_p05.json: register scan reached the band text (15 band(s) read: {'activity_title': 5, 'materials': 8, 'teacher_notes': 5, 'time_bands': 15, 'homework': 2})
...
PASS  ch_03_canonical.json: every question_type is a known assessment type (0 not)
      ADVISORY ch_03_canonical.json: ['TRUE_FALSE'] used by exactly one item in the whole library — check it against the constitution's type table
...
serve sweep: {"3": "fill/forward -3s", "4": "fill/forward -1s", "5": "identity", "6": "rescue/complete (from 8)", "7": "fill/backward", "8": "identity", "9": "surrender", "10": "surrender"}
