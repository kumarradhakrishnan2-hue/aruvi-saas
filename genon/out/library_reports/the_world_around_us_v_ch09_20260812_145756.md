# Library certification · the_world_around_us V ch 9 · 20260812_145756
...
FAIL  ch_09_canonical_p10.json: register clean (1 ban hit(s))
      U5 time_bands[3] 38–40 [forward] …brief oral pause that plants the idea of seasonality before the next unit's work.
...
FAIL  ch_09_canonical_p07.json: register clean (1 ban hit(s))
      U3 time_bands[3] 38-40 [forward] …s respond briefly. The chart remains posted on the wall for the following unit.
      -> declare the fixes in genon/repair_register.py and re-run --certify-only; do NOT hand-edit the artefact
...
options arranged: 5 of 7 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ch_09_canonical.json: 0 of 2 item(s) re-ordered
      ch_09_canonical_p07.json: 2 of 2 item(s) re-ordered
          #1 C-1.3 U1: A–D now hold ADCB · correct C -> C
          #3 C-2.1 U3: A–D now hold BDAC · correct B -> A
      ch_09_canonical_p10.json: 3 of 3 item(s) re-ordered
          #1 C-1.3 U1: A–D now hold DBCA · correct B -> B
          #3 C-7.2 U4: A–D now hold ACDB · correct C -> B
          #6 C-1.3 U7: A–D now hold DACB · correct C -> C
