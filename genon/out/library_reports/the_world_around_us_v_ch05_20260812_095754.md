# Library certification · the_world_around_us V ch 5 · 20260812_095754
...
PASS  ch_05_canonical.json: every question_type is one the chapter uses (0 outlier)
...
PASS  ch_05_canonical_p13.json: every question_type is one the chapter uses (0 outlier)
...
FAIL  ch_05_canonical_p10.json: every question_type is one the chapter uses (1 outlier)
      unit [7]: question_type 'ECR' is used by no other item — the chapter's set is ['MCQ', 'OPEN_TASK', 'SCR']
      -> check the assessment constitution's type-selection TABLE: its left column is another enumeration and this is usually a value copied from the wrong column
...
QUARANTINED  ch_05_canonical_p10.json -> backup/quarantine/the_world_around_us/v/ch_05_canonical_p10_20260812_095754.json
