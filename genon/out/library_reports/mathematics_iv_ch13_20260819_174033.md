# Library certification · mathematics IV ch 13 · 20260819_174033

plan: counts [16, 13, 10] · basis authored_standard · registry 9 sections

FAIL  library complete: ['ch_13_canonical.json'] vs plan [16, 13, 10]
...
options arranged: 5 of 7 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ch_13_canonical.json: 5 of 7 item(s) re-ordered
          #5 None #5: A–D now hold ADCB · correct A -> A
          #8 None #8: A–D now hold CABD · correct A -> B
          #12 None #12: A–D now hold ADCB · correct A -> A
          #15 None #15: A–D now hold DCAB · correct A -> C
          #16 None #16: A–D now hold DABC · correct A -> B
