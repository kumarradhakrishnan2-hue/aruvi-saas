# Library certification · mathematics VII ch 7 · 20260820_104746
...
PASS  ch_07_canonical.json: register scan reached the band text (48 band(s) read: {'activity_title': 12, 'materials': 69, 'teacher_notes': 12, 'time_bands': 48, 'homework': 7, 'visual_aids': 1})
FAIL  ch_07_canonical.json: register clean (1 ban hit(s))
      U12 teacher_notes [clock] …board. Students work individually with full written working for roughly fifteen minutes, then compare in groups of three — any disagreement must be…
