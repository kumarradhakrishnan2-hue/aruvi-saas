# Library certification · the_world_around_us V ch 8 · 20260812_141622

plan: counts [10, 8, 6] · basis authored_standard · registry 5 sections

FAIL  library complete: ['ch_08_canonical.json'] vs plan [10, 8, 6]
...
FAIL  ch_08_canonical.json: register clean (1 ban hit(s))
      U3 time_bands[3] 34-40 [completion] …muslin as 'woven air' and asks what that phrase might mean now that students have seen threads up close.
...
serve sweep: {"4": "fill/single -3s", "5": "fill/single -2s", "6": "fill/single -1s", "7": "fill/single -1s", "8": "fill/single", "9": "fill/single", "10": "identity", "11": "surrender", "12": "surrender"}
...
options arranged: 3 of 3 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ch_08_canonical.json: 3 of 3 item(s) re-ordered
          #1 C-7.2 U1: A–D now hold BDAC · correct B -> A
          #3 C-1.1 U3: A–D now hold BADC · correct B -> A
          #6 C-1.1 U6: A–D now hold CABD · correct B -> C
