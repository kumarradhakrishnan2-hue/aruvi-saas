# Library certification · the_world_around_us V ch 1 · 20260813_180918
...
PASS  ch_01_canonical.json: every section the chapter summary carries is anchored by some unit (7 summary section(s) vs 7 registry entr(ies))
...
PASS  ch_01_canonical.json: register clean (0 ban hit(s))
      ADVISORY ch_01_canonical.json: 1 artefact-dependency hit(s) — a unit reaching for something a PREVIOUS sitting produced. Read them: the brief forbids it, certification cannot.
        U3 time_bands[0] 0-6: 'from the previous unit' — …the three states of water by pointing to the board diagram from the previous unit's content. Then holds up a transparent bag and coloured wat…
...
options arranged: 0 of 10 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ...
      ch_01_canonical_p08.json: 0 of 3 item(s) re-ordered
      ch_01_canonical_p11.json: 0 of 3 item(s) re-ordered
