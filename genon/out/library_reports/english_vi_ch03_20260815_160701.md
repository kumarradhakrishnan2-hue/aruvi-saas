# Library certification · english VI ch 3 · 20260815_160701
...
PASS  ch_03_canonical.json: every section the chapter summary carries is anchored by some unit (6 summary section(s) vs 5 registry entr(ies))
...
PASS  ch_03_canonical.json: register scan reached the band text (30 band(s) read: {'activity_title': 10, 'materials': 16, 'teacher_notes': 10, 'time_bands': 30, 'homework': 1})
PASS  ch_03_canonical.json: register clean (0 ban hit(s))
PASS  ch_03_canonical_p08.json: register scan reached the band text (28 band(s) read: {'activity_title': 8, 'materials': 10, 'teacher_notes': 8, 'time_bands': 28, 'homework': 2})
PASS  ch_03_canonical_p08.json: register clean (0 ban hit(s))
PASS  ch_03_canonical_p06.json: register scan reached the band text (21 band(s) read: {'activity_title': 6, 'materials': 13, 'teacher_notes': 6, 'time_bands': 21, 'homework': 2})
...
PASS  ch_03_canonical_p06.json: every question_type is a known assessment type (0 not)
      ADVISORY ch_03_canonical_p06.json: ['FILL_IN'] used by exactly one item in the whole library — check it against the constitution's type table
...
serve sweep: {"4": "fill/forward -2s", "5": "fill/single -1s", "6": "identity", "7": "fill/single", "8": "identity", "9": "synthesis", "10": "identity", "11": "surrender", "12": "surrender"}
...
options arranged: 4 of 6 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ...
      ch_03_canonical_p08.json: 2 of 2 item(s) re-ordered
          ...
          #3 None #3: A–D now hold 2341 · correct 4 -> 3
