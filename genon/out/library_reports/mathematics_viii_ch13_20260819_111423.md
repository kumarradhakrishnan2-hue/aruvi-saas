# Library certification · mathematics VIII ch 13 · 20260819_111423

plan: counts [6, 4] · basis authored_standard · registry 6 sections

FAIL  library complete: ['ch_13_canonical.json'] vs plan [6, 4]
...
PASS  ch_13_canonical.json: register scan reached the band text (24 band(s) read: {'activity_title': 6, 'materials': 13, 'teacher_notes': 6, 'time_bands': 24, 'homework': 4})
...
PASS  ch_13_canonical.json: every question_type is a known assessment type (0 not)
      ADVISORY ch_13_canonical.json: ['ECR', 'MCQ'] used by exactly one item in the whole library — check it against the constitution's type table
...
serve sweep: {"2": "fill/single -3s", "3": "fill/single -3s", "4": "fill/backward -2s", "5": "fill/forward", "6": "identity", "7": "surrender", "8": "surrender"}
...
options arranged: 1 of 1 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ch_13_canonical.json: 1 of 1 item(s) re-ordered
