# Library certification · mathematics IV ch 10 · 20260819_174032
...
serve sweep: {"5": "fill/backward -4s", "6": "fill/single -3s", "7": "fill/single -3s", "8": "fill/single -2s", "9": "fill/single -1s", "10": "fill/single -1s", "11": "fill/single", "12": "identity", "13": "surrender", "14": "surrender"}
...
options arranged: 4 of 6 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ch_10_canonical.json: 4 of 6 item(s) re-ordered
          #4 None #4: A–D now hold DABC · correct A -> B
          #5 None #5: A–D now hold BACD · correct B -> A
          #7 None #7: A–D now hold CDAB · correct B -> D
