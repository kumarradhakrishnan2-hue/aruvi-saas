# Library certification · the_world_around_us III ch 3 · 20260812_145758
...
FAIL  ch_03_canonical_p08.json: register clean (1 ban hit(s))
      U8 teacher_facilitation_note [calendar] Ask: If a new student joined your school tomorrow and could not read the signs, which of your signs would sti…
...
FAIL  ch_03_canonical_p06.json: register clean (1 ban hit(s))
      U6 time_bands[4] 35-40 [clock] …gnboards on their desks, and the class moves around to look for one or two minutes. Each student reads at least two signs made by others. The…
      -> declare the fixes in genon/repair_register.py and re-run --certify-only; do NOT hand-edit the artefact
...
options arranged: 4 of 8 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ...
      ch_03_canonical_p06.json: 2 of 2 item(s) re-ordered
          #1 C-6.1 U1: A–D now hold DABC · correct B -> C
          #3 C-4.1 U3: A–D now hold BCDA · correct C -> B
      ch_03_canonical_p08.json: 2 of 2 item(s) re-ordered
          #1 C-4.1 U1: A–D now hold DBAC · correct B -> B
          #5 C-2.2 U5: A–D now hold BDAC · correct B -> A
