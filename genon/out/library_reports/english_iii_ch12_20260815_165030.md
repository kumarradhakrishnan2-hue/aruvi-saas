# Library certification · english III ch 12 · 20260815_165030
...
PASS  ch_12_canonical.json: every question_type is a known assessment type (0 not)
      ADVISORY ch_12_canonical.json: ['FILL_IN', 'MATCH', 'MCQ', 'PROJECT', 'TRUE_FALSE', 'WRITING_TASK'] used by exactly one item in the whole library — check it against the constitution's type table
...
serve sweep: {"3": "fill/single -3s", "4": "fill/single -2s", "5": "fill/single -2s", "6": "fill/single -1s", "7": "fill/single", "8": "fill/single", "9": "identity", "10": "surrender", "11": "surrender"}
