# Library certification · english VI ch 14 · 20260814_155003
...
PASS  ch_14_canonical.json: every question_type is a known assessment type (0 not)
      ADVISORY ch_14_canonical.json: ['ECR', 'MATCH', 'MCQ', 'PROJECT', 'TRUE_FALSE'] used by exactly one item in the whole library — check it against the constitution's type table
...
serve sweep: {"3": "fill/single -4s", "4": "fill/single -4s", "5": "fill/single -4s", "6": "fill/forward -2s", "7": "fill/single -1s", "8": "fill/single", "9": "identity", "10": "surrender", "11": "surrender"}
