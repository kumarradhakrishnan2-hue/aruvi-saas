# Library certification · english VII ch 15 · 20260814_155006
...
FAIL  library complete: ['ch_15_canonical.json'] vs plan [6, 4]
...
PASS  ch_15_canonical.json: every question_type is a known assessment type (0 not)
      ADVISORY ch_15_canonical.json: ['ECR', 'PROJECT', 'TRUE_FALSE'] used by exactly one item in the whole library — check it against the constitution's type table
