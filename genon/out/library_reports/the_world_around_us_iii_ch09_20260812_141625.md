# Library certification · the_world_around_us III ch 9 · 20260812_141625

plan: counts [6, 4] · basis authored_standard · registry 4 sections

FAIL  library complete: ['ch_09_canonical.json'] vs plan [6, 4]
...
PASS  ch_09_canonical.json: every question_type is a known assessment type (0 not)
      ADVISORY ch_09_canonical.json: ['ECR', 'SCR'] used by exactly one item in the whole library — check it against the constitution's type table
...
serve sweep: {"2": "fill/single -2s", "3": "fill/single -1s", "4": "fill/single", "5": "synthesis", "6": "identity", "7": "surrender", "8": "surrender"}
...
options arranged: 2 of 2 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ch_09_canonical.json: 2 of 2 item(s) re-ordered
          #3 C-3.1 U3: A–D now hold BADC · correct B -> A
          #5 C-4.2 U5: A–D now hold BCDA · correct C -> B
