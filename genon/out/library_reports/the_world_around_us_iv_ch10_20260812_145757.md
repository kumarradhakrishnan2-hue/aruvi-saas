# Library certification · the_world_around_us IV ch 10 · 20260812_145757
...
FAIL  ch_10_canonical_p08.json: register clean (1 ban hit(s))
      U7 time_bands[2] 22-35 [completion] …he natural strand across the whole chapter without claiming the chapter is complete.
...
options arranged: 3 of 6 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ...
      ch_10_canonical_p06.json: 1 of 1 item(s) re-ordered
          #3 C-6.1 U3: A–D now hold DABC · correct A -> B
      ch_10_canonical_p08.json: 2 of 2 item(s) re-ordered
          #2 C-1.1 U2: A–D now hold DACB · correct B -> D
          #5 C-1.3 U5: A–D now hold CDAB · correct B -> D
