# Library certification · mathematics VIII ch 11 · 20260820_122611
...
PASS  ch_11_canonical.json: register scan reached the band text (67 band(s) read: {'activity_title': 17, 'materials': 59, 'teacher_notes': 17, 'time_bands': 67, 'homework': 3, 'visual_aids': 1})
...
PASS  ch_11_canonical_p14.json: no stem points at a figure the item does not carry (0 does)
PASS  ch_11_canonical_p10.json: no stem points at a figure the item does not carry (0 does)
