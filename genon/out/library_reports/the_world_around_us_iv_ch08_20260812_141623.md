# Library certification · the_world_around_us IV ch 8 · 20260812_141623
...
FAIL  ch_08_canonical.json: register clean (2 ban hit(s))
      U6 time_bands[2] 22-33 [calendar] …ready make at home? Which one would be the easiest to start tomorrow? Students write two sentences in their notebooks: one thing…
      U11 time_bands[1] 8-24 [calendar] …tes, asking groups: is this something you could actually do tomorrow? Is it something your family already does?
...
options arranged: 4 of 4 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ch_08_canonical.json: 4 of 4 item(s) re-ordered
          #1 C-4.3 U1: A–D now hold ADCB · correct A -> A
          #4 C-6.1 U4: A–D now hold BDAC · correct A -> C
          #7 C-4.4 U7: A–D now hold BDAC · correct A -> C
          #12 C-4.3 U12: A–D now hold ADBC · correct A -> A
