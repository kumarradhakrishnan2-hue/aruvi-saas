# Library certification · mathematics III ch 7 · 20260820_104951

plan: counts [14, 11, 8] · basis authored_standard · registry 13 sections

FAIL  library complete: ['ch_07_canonical.json', 'ch_07_canonical_p08.json'] vs plan [14, 11, 8]
...
serve sweep: {"6": "fill/forward -3s", "7": "fill/single -2s", "8": "identity", "9": "rescue/complete (from 14)", "10": "fill/single -3s", "11": "fill/single -2s", "12": "fill/forward", "13": "fill/forward", "14": "identity", "15": "surrender", "16": "surrender"}

options arranged: 1 of 11 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ch_07_canonical.json: 0 of 5 item(s) re-ordered
      ch_07_canonical_p08.json: 1 of 6 item(s) re-ordered
          #5 None #5: A–D now hold CABD · correct B -> C
