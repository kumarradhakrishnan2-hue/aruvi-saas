# Library certification · english IX ch 2 · 20260814_143136
...
PASS  library complete: ['ch_02_canonical.json', 'ch_02_canonical_p05.json'] vs plan [6, 5]
...
PASS  ch_02_canonical_p05.json: register scan reached the band text (19 band(s) read: {'activity_title': 5, 'materials': 11, 'teacher_notes': 5, 'time_bands': 19, 'homework': 2})
...
PASS  ch_02_canonical_p05.json: every question_type is a known assessment type (0 not)
      ADVISORY ch_02_canonical_p05.json: ['MCQ'] used by exactly one item in the whole library — check it against the constitution's type table
...
serve sweep: {"2": "fill/backward -4s", "3": "fill/backward -4s", "4": "fill/forward -1s", "5": "identity", "6": "identity", "7": "surrender", "8": "surrender"}
...
options arranged: 2 of 3 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ...
      ch_02_canonical_p05.json: 2 of 2 item(s) re-ordered
          ...
          #3 None #3: A–D now hold 1423 · correct 2 -> 3
