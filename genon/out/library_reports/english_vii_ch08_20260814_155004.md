# Library certification · english VII ch 8 · 20260814_155004
...
PASS  ch_08_canonical.json: every question_type is a known assessment type (0 not)
      ADVISORY ch_08_canonical.json: ['MATCH', 'MCQ', 'PROJECT', 'TRUE_FALSE'] used by exactly one item in the whole library — check it against the constitution's type table
