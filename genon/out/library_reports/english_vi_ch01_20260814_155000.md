# Library certification · english VI ch 1 · 20260814_155000
...
PASS  ch_01_canonical.json: every question_type is a known assessment type (0 not)
      ADVISORY ch_01_canonical.json: ['ECR', 'MCQ', 'PROJECT', 'TRUE_FALSE'] used by exactly one item in the whole library — check it against the constitution's type table
...
serve sweep: {"3": "fill/single -4s", "4": "fill/single -4s", "5": "fill/single -3s", "6": "fill/single -2s", "7": "fill/forward", "8": "identity", "9": "surrender", "10": "surrender"}
...
options arranged: 2 of 2 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ch_01_canonical.json: 2 of 2 item(s) re-ordered
          ...
          #3 None #3: A–D now hold 3241 · correct 4 -> 3
