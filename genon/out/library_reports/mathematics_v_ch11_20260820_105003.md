# Library certification · mathematics V ch 11 · 20260820_105003

plan: counts [11, 9, 7] · basis authored_standard · registry 6 sections

FAIL  library complete: ['ch_11_canonical.json', 'ch_11_canonical_p09.json'] vs plan [11, 9, 7]
...
serve sweep: {"5": "fill/single -2s", "6": "fill/single -1s", "7": "fill/single", "8": "fill/single", "9": "identity", "10": "fill/single", "11": "identity", "12": "surrender", "13": "surrender"}

options arranged: 5 of 11 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ...
      ch_11_canonical_p09.json: 5 of 5 item(s) re-ordered
          ...
          #3 None #3: A–D now hold CADB · correct A -> B
          #4 None #4: A–D now hold DBCA · correct B -> B
          #7 None #7: A–D now hold BADC · correct B -> A
