# Library certification · mathematics VIII ch 2 · 20260819_114206
...
PASS  ch_02_canonical.json: every question_type is a known assessment type (0 not)
      ADVISORY ch_02_canonical.json: ['ECR'] used by exactly one item in the whole library — check it against the constitution's type table
...
serve sweep: {"5": "fill/single -3s", "6": "fill/single -3s", "7": "fill/single -2s", "8": "fill/single -2s", "9": "fill/single -1s", "10": "fill/single", "11": "fill/single", "12": "identity", "13": "surrender", "14": "surrender"}
...
options arranged: 2 of 3 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ch_02_canonical.json: 2 of 3 item(s) re-ordered
          #1 None #1: A–D now hold ACBD · correct B -> C
          #3 None #3: A–D now hold CDAB · correct A -> C
