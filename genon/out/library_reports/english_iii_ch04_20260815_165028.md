# Library certification · english III ch 4 · 20260815_165028
...
PASS  ch_04_canonical.json: every question_type is a known assessment type (0 not)
      ADVISORY ch_04_canonical.json: ['FILL_IN', 'MCQ', 'PROJECT', 'SCR', 'TRUE_FALSE', 'WRITING_TASK'] used by exactly one item in the whole library — check it against the constitution's type table
...
serve sweep: {"5": "fill/single -2s", "6": "fill/single -1s", "7": "fill/single -1s", "8": "fill/single", "9": "synthesis", "10": "synthesis", "11": "identity", "12": "surrender", "13": "surrender"}
...
options arranged: 1 of 2 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ch_04_canonical.json: 1 of 2 item(s) re-ordered
