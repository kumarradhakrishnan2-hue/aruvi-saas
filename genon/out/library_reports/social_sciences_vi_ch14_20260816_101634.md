# Library certification · social_sciences VI ch 14 · 20260816_101634
...
FAIL  ch_14_canonical_p07.json: register clean (4 ban hit(s))
      U1 teacher_notes [forward] …this cleanly. The criteria brainstorm at the close sets up the next unit's classification work without pre-empting it.
      U2 time_bands[3] 34-40 [forward] …teacher collects these slips to gauge understanding before the next unit.
      U4 time_bands[2] 22-34 [clock] …and write the finished product. Students work individually for five minutes, then share in a quick round-robin. The teacher records nov…
      U4 time_bands[3] 34-40 [forward] …dents write one sentence; three responses are read aloud to bridge toward the interdependence theme.
...
FAIL  ch_14_canonical_p05.json: register clean (1 ban hit(s))
      U5 teacher_notes [completion] …AMUL interdependence model and the three-sector definitions built across this chapter, this unit moves from a named case study to the students' o…
      -> declare the fixes in genon/repair_register.py and re-run --certify-only; do NOT hand-edit the artefact
...
options arranged: 8 of 12 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ...
      ch_14_canonical_p05.json: 4 of 4 item(s) re-ordered
          #1 C-9.1 U1: A–D now hold ABDC · correct A -> A
          #2 C-9.1 U2: A–D now hold ADCB · correct B -> D
          #6 C-4.1 U4: A–D now hold DBAC · correct B -> B
          #7 C-4.1 U5: A–D now hold BCDA · correct B -> A
      ch_14_canonical_p07.json: 4 of 4 item(s) re-ordered
          #1 C-9.1 U1: A–D now hold DACB · correct B -> D
          #2 C-9.1 U2: A–D now hold BACD · correct B -> A
          #6 C-4.1 U7: A–D now hold CDBA · correct B -> C
          #7 C-4.1 U7: A–D now hold BADC · correct C -> D
