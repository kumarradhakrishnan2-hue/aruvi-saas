# Library certification · the_world_around_us IV ch 1 · 20260812_145756
...
PASS  ch_01_canonical.json: every handoff row routes to a unit that anchors its section
      ...
      ADVISORY ch_01_canonical.json: 9 unit(s) wear a section label the handoff does not route items through: U1=a tour around my village, U2=a tour around my village, U3=van mahotsav: a festival for planting trees, U4=helping hands in the community, U5=helping hands in the community, U6=celebrating van mahotsav …  (do NOT extend period_numbers to fix this — it moves the item to a later unit and loses it on short serves)
PASS  ch_01_canonical_p08.json: every handoff row routes to a unit that anchors its section
      ...
      ADVISORY ch_01_canonical_p08.json: 8 unit(s) wear a section label the handoff does not route items through: U1=a tour around my village, U2=a tour around my village, U3=van mahotsav: a festival for planting trees, U4=helping hands in the community, U5=helping hands in the community, U6=celebrating van mahotsav …  (do NOT extend period_numbers to fix this — it moves the item to a later unit and loses it on short serves)
PASS  ch_01_canonical_p06.json: every handoff row routes to a unit that anchors its section
      ...
      ADVISORY ch_01_canonical_p06.json: 6 unit(s) wear a section label the handoff does not route items through: U1=a tour around my village, U2=van mahotsav: a festival for planting trees, U3=helping hands in the community, U4=celebrating van mahotsav, U5=sharing a meal, U6=let us reflect  (do NOT extend period_numbers to fix this — it moves the item to a later unit and loses it on short serves)
PASS  ch_01_canonical.json: register scan reached the band text (40 band(s) read: {'activity_title': 10, 'materials': 33, 'visual_aids': 7, 'teacher_facilitation_note': 10, 'time_bands': 40})
PASS  ch_01_canonical.json: register clean (0 ban hit(s))
PASS  ch_01_canonical_p08.json: register scan reached the band text (32 band(s) read: {'activity_title': 8, 'materials': 28, 'visual_aids': 6, 'teacher_facilitation_note': 8, 'time_bands': 32})
PASS  ch_01_canonical_p08.json: register clean (0 ban hit(s))
PASS  ch_01_canonical_p06.json: register scan reached the band text (24 band(s) read: {'activity_title': 6, 'materials': 21, 'visual_aids': 6, 'teacher_facilitation_note': 6, 'time_bands': 24})
FAIL  ch_01_canonical_p06.json: register clean (1 ban hit(s))
      U4 time_bands[1] 10-22 [clock] …Can you remember one such occasion?' Students think quietly for two minutes, then share in groups of three. Each group picks its most v…
...
serve sweep: {"4": "fill/single -2s", "5": "fill/single -1s", "6": "identity", "7": "rescue/complete (from 8)", "8": "identity", "9": "synthesis", "10": "identity", "11": "surrender", "12": "surrender"}
...
options arranged: 2 of 6 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ...
      ch_01_canonical_p06.json: 1 of 1 item(s) re-ordered
          #1 C-1.4 U1: A–D now hold DACB · correct A -> B
      ch_01_canonical_p08.json: 1 of 2 item(s) re-ordered
          #6 C-4.7 U6: A–D now hold DCAB · correct C -> B
