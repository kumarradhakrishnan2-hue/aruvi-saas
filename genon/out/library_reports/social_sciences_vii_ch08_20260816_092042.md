# Library certification · social_sciences VII ch 8 · 20260816_092042

plan: counts [16, 13, 10] · basis authored_standard · registry 9 sections

FAIL  library complete: ['ch_08_canonical.json'] vs plan [16, 13, 10]
...
serve sweep: {"8": "fill/single -3s", "9": "fill/single -2s", "10": "fill/single -1s", "11": "fill/single", "12": "synthesis", "13": "synthesis", "14": "synthesis", "15": "synthesis", "16": "identity", "17": "surrender", "18": "surrender"}
...
options arranged: 8 of 8 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ch_08_canonical.json: 8 of 8 item(s) re-ordered
          #1 C-7.1 U2: A–D now hold BDAC · correct B -> A
          #2 C-7.1 U3: A–D now hold CDBA · correct B -> C
          #6 C-6.3 U5: A–D now hold ADBC · correct B -> C
          #7 C-6.3 U7: A–D now hold ADCB · correct B -> D
          #9 C-7.2 U4: A–D now hold DCBA · correct B -> C
          #10 C-7.2 U6: A–D now hold CBDA · correct B -> B
          #11 C-7.3 U2: A–D now hold BADC · correct B -> A
          #12 C-7.3 U10: A–D now hold BDAC · correct B -> A
