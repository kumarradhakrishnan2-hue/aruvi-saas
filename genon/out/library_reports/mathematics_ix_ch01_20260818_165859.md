# Library certification · mathematics IX ch 1 · 20260818_165859
...
PASS  ch_01_canonical_p08.json: every handoff row routes to a unit that anchors its section
      handoff/anchor: 4 handoff group(s) for 8 unit(s) — at most 4 unit(s) can carry an item, so 4 without one is arithmetic, not a defect
PASS  ch_01_canonical_p06.json: every handoff row routes to a unit that anchors its section
      handoff/anchor: 4 handoff group(s) for 6 unit(s) — at most 4 unit(s) can carry an item, so 2 without one is arithmetic, not a defect
...
PASS  ch_01_canonical_p08.json: register scan reached the band text (32 band(s) read: {'activity_title': 8, 'materials': 28, 'teacher_notes': 8, 'time_bands': 32, 'visual_aids': 4, 'homework': 1})
FAIL  ch_01_canonical_p08.json: register clean (3 ban hit(s))
      U2 time_bands[2] 25-42 [forward] …nvention — a preview of why the formal coordinate system in the next unit matters.
      U2 time_bands[3] 42-50 [forward] …has signed convention and a fixed origin) as the bridge to the next unit.
      U3 time_bands[2] 25-40 [clock] …always have a zero coordinate? Students reason individually for two minutes, then discuss in pairs. Bring out the deductive argument: i…
      -> declare the fixes in genon/repair_register.py and re-run --certify-only; do NOT hand-edit the artefact
PASS  ch_01_canonical_p06.json: register scan reached the band text (25 band(s) read: {'activity_title': 6, 'materials': 18, 'visual_aids': 6, 'teacher_notes': 6, 'time_bands': 25, 'homework': 1})
...
PASS  ch_01_canonical_p08.json: every question_type is a known assessment type (0 not)
      ADVISORY ch_01_canonical_p08.json: ['SCR'] used by exactly one item in the whole library — check it against the constitution's type table
...
item counts per competency — ADVISORY, does not gate; basis: derived (modal count across this library — no constitution row yet)
      ...
      ch_01_canonical_p08.json: 5 items vs 5 expected
...
serve sweep: {"4": "fill/single", "5": "fill/single", "6": "identity", "7": "synthesis", "8": "identity", "9": "synthesis", "10": "identity", "11": "surrender", "12": "surrender"}
...
options arranged: 3 of 6 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ...
      ch_01_canonical_p06.json: 2 of 2 item(s) re-ordered
          #1 C-4.5 S1: A–D now hold DBAC · correct A -> C
          #3 C-4.5 S3: A–D now hold CABD · correct A -> B
      ch_01_canonical_p08.json: 1 of 1 item(s) re-ordered
          #3 C-4.5 S3: A–D now hold CABD · correct B -> C
