# Library certification · mathematics VIII ch 12 · 20260819_111422
...
FAIL  ch_12_canonical.json: register clean (1 ban hit(s))
      U1 teacher_notes [forward] …ished that the mean is a uniquely determined balance point, later units can build on this to reason about how adding or removing va…
...
serve sweep: {"8": "fill/single", "9": "synthesis", "10": "synthesis", "11": "synthesis", "12": "synthesis", "13": "synthesis", "14": "synthesis", "15": "synthesis", "16": "identity", "17": "surrender", "18": "surrender"}
...
options arranged: 3 of 3 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ch_12_canonical.json: 3 of 3 item(s) re-ordered
          #6 None #6: A–D now hold ADBC · correct B -> C
          #11 None #11: A–D now hold CDAB · correct B -> D
          #14 None #14: A–D now hold DABC · correct B -> C
