# Library certification · social_sciences IX ch 7 · 20260813_180158
...
serve granularity: unit  ·  section axis: True
      ADVISORY ch_07_canonical.json: 1 prose lead(s) in the summary match no registry entry (9 summary section(s) vs 8 registry entr(ies)) — rule on each by eye, a sub-topic is not a section: Inside India's Election Machinery
...
options arranged: 0 of 12 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ...
      ch_07_canonical_p05.json: 0 of 4 item(s) re-ordered
      ch_07_canonical_p07.json: 0 of 4 item(s) re-ordered
