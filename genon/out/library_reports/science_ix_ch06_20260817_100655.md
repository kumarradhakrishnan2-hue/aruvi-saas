# Library certification · science IX ch 6 · 20260817_100655
...
FAIL  ch_06_canonical.json: register clean (2 ban hit(s))
      ...
      U5 time_bands[4] 48-50 [forward] …e would move forever at constant velocity — is flagged as a bridge to the law students will formalise next.
      U20 teacher_notes [forward] …ce three-law summary at the close is an explicit conceptual bridge to the synthesis unit; encourage precise, original phrasing rather…
...
options arranged: 2 of 2 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ch_06_canonical.json: 2 of 2 item(s) re-ordered
          ...
          #2 C-2.1 S2: A–D now hold CBDA · correct B -> B
