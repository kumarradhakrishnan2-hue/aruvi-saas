# Library certification · mathematics VIII ch 5 · 20260819_133845
...
PASS  ch_05_canonical.json: register scan reached the band text (47 band(s) read: {'activity_title': 12, 'materials': 24, 'teacher_notes': 12, 'time_bands': 47, 'homework': 4})
...
FAIL  ch_05_canonical_p10.json: register clean (1 ban hit(s))
      U6 teacher_notes [forward] …focus exclusively on 9 and let the parallel for 3 emerge in the next unit where it is formally treated. Watch for students who apply…
...
options arranged: 3 of 6 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ...
      ch_05_canonical_p07.json: 2 of 2 item(s) re-ordered
          #1 None #1: A–D now hold CABD · correct B -> C
          #4 None #4: A–D now hold CBAD · correct B -> B
      ch_05_canonical_p10.json: 1 of 1 item(s) re-ordered
          #3 None #3: A–D now hold ADBC · correct B -> C
