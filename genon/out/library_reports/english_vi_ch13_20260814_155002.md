# Library certification · english VI ch 13 · 20260814_155002
...
FAIL  ch_13_canonical.json: register clean (1 ban hit(s))
      U5 time_bands[2] 18–35 [clock] Five or six students present to the class, each for about two to three minutes. The class listens actively and may ask one clarifying ques…
...
PASS  ch_13_canonical.json: every question_type is a known assessment type (0 not)
      ADVISORY ch_13_canonical.json: ['ECR', 'FILL_IN', 'MATCH', 'PROJECT', 'TRUE_FALSE'] used by exactly one item in the whole library — check it against the constitution's type table
...
serve sweep: {"3": "fill/single -4s", "4": "fill/single -4s", "5": "fill/single -3s", "6": "fill/single -2s", "7": "fill/single -1s", "8": "fill/single", "9": "identity", "10": "surrender", "11": "surrender"}
...
options arranged: 1 of 1 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ch_13_canonical.json: 1 of 1 item(s) re-ordered
          #1 None #1: A–D now hold 1342 · correct 1 -> 1
