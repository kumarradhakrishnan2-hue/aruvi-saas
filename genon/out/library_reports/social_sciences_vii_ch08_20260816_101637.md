# Library certification · social_sciences VII ch 8 · 20260816_101637
...
options arranged: 14 of 22 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ch_08_canonical.json: 0 of 8 item(s) re-ordered
      ch_08_canonical_p10.json: 8 of 8 item(s) re-ordered
          #1 C-7.1 U3: A–D now hold ABDC · correct B -> B
          #2 C-7.1 U4: A–D now hold ADCB · correct C -> C
          #6 C-6.3 U5: A–D now hold CABD · correct C -> A
          #7 C-6.3 U9: A–D now hold BACD · correct B -> A
          #9 C-7.2 U4: A–D now hold DCAB · correct A -> C
          #10 C-7.2 U8: A–D now hold CDAB · correct B -> D
          #11 C-7.3 U2: A–D now hold BCAD · correct B -> A
          #12 C-7.3 U2: A–D now hold BADC · correct B -> A
      ch_08_canonical_p13.json: 6 of 6 item(s) re-ordered
          #1 C-7.1 U2: A–D now hold DCBA · correct B -> C
          #2 C-7.1 U5: A–D now hold CBAD · correct C -> A
          #6 C-6.3 U6: A–D now hold BADC · correct B -> A
          #7 C-6.3 U9: A–D now hold DCBA · correct B -> C
          #9 C-7.2 U4: A–D now hold CABD · correct B -> C
          #10 C-7.3 U2: A–D now hold DACB · correct C -> C
QUARANTINED  ch_08_canonical_p13.json -> backup/quarantine/social_sciences/vii/ch_08_canonical_p13_20260816_101637.json
