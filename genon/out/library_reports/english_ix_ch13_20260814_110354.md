# Library certification · english IX ch 13 · 20260814_110354

plan: counts [15, 12, 9] · basis authored_standard · registry 6 sections

FAIL  library complete: ['ch_13_canonical.json'] vs plan [15, 12, 9]
...
PASS  ch_13_canonical.json: every question_type is a known assessment type (0 not)
      ADVISORY ch_13_canonical.json: ['ECR', 'EXTRACT_ANALYSIS', 'MATCH', 'MCQ', 'PROJECT', 'TRUE_FALSE'] used by exactly one item in the whole library — check it against the constitution's type table
...
serve sweep: {"7": "fill/single -4s", "8": "fill/single -3s", "9": "fill/single -3s", "10": "fill/single -3s", "11": "fill/single -2s", "12": "fill/single -1s", "13": "fill/single", "14": "synthesis", "15": "identity", "16": "surrender", "17": "surrender"}
