# Library certification · mathematics VIII ch 1 · 20260819_133843
...
PASS  ch_01_canonical.json: register scan reached the band text (34 band(s) read: {'activity_title': 9, 'materials': 25, 'teacher_notes': 9, 'time_bands': 34, 'homework': 3})
...
FAIL  ch_01_canonical_p05.json: register clean (1 ban hit(s))
      U5 time_bands[3] 38–45 [completion] …every major result from squares, cube properties, and roots covered across the chapter's five units.
...
options arranged: 2 of 4 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ...
      ch_01_canonical_p05.json: 1 of 1 item(s) re-ordered
          #2 None #2: A–D now hold CBAD · correct A -> C
      ch_01_canonical_p07.json: 1 of 1 item(s) re-ordered
          #1 None #1: A–D now hold BDCA · correct C -> C
