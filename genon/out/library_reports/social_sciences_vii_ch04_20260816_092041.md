# Library certification · social_sciences VII ch 4 · 20260816_092041
...
FAIL  ch_04_canonical.json: register clean (2 ban hit(s))
      U1 teacher_notes [forward] …rs the contrast and will serve as a reference frame for the sections that follow.
      U19 time_bands[0] 0-8 [clock] …apter describes in each domain.' Students work individually for four minutes, then compare with a partner.
...
serve sweep: {"9": "fill/single", "10": "fill/single", "11": "synthesis", "12": "synthesis", "13": "synthesis", "14": "synthesis", "15": "synthesis", "16": "synthesis", "17": "synthesis", "18": "synthesis", "19": "identity", "20": "surrender", "21": "surrender"}
...
options arranged: 7 of 10 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ch_04_canonical.json: 7 of 10 item(s) re-ordered
          #1 C-2.1 U1: A–D now hold BDAC · correct B -> A
          #2 C-2.1 U12: A–D now hold ADCB · correct B -> D
          #7 C-3.1 U9: A–D now hold BACD · correct B -> A
          #10 C-3.2 U16: A–D now hold ACDB · correct B -> D
          #11 C-5.1 U9: A–D now hold ADBC · correct D -> B
          #12 C-5.1 U16: A–D now hold DACB · correct B -> D
          #14 C-4.1 U18: A–D now hold DBCA · correct B -> B
