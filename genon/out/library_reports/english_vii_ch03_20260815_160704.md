# Library certification · english VII ch 3 · 20260815_160704
...
PASS  ch_03_canonical.json: register scan reached the band text (37 band(s) read: {'activity_title': 9, 'materials': 15, 'teacher_notes': 9, 'time_bands': 37, 'homework': 2})
PASS  ch_03_canonical.json: register clean (0 ban hit(s))
PASS  ch_03_canonical_p07.json: register scan reached the band text (26 band(s) read: {'activity_title': 7, 'materials': 20, 'teacher_notes': 7, 'time_bands': 26, 'homework': 2})
FAIL  ch_03_canonical_p07.json: register clean (1 ban hit(s))
      U3 time_bands[0] 0–8 [calendar] …e Keller appeals to sighted readers to use their eyes as if tomorrow they might be blind. Students underline the key imperative…
      -> declare the fixes in genon/repair_register.py and re-run --certify-only; do NOT hand-edit the artefact
PASS  ch_03_canonical_p05.json: register scan reached the band text (16 band(s) read: {'activity_title': 5, 'materials': 13, 'teacher_notes': 5, 'time_bands': 16, 'homework': 2})
...
options arranged: 3 of 6 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ...
      ch_03_canonical_p05.json: 1 of 2 item(s) re-ordered
          #1 None #1: A–D now hold 4123 · correct 2 -> 3
