# Library certification · mathematics VIII ch 14 · 20260819_133848
...
FAIL  ch_14_canonical_p11.json: register clean (1 ban hit(s))
      U11 time_bands[2] 28–40 [completion] …le of equal area”): students apply the dissection knowledge built across the chapter to write a step-by-step procedure, connecting the Śulba-Sūt…
...
options arranged: 2 of 5 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ...
      ch_14_canonical_p08.json: 1 of 1 item(s) re-ordered
          #1 None #1: A–D now hold DBCA · correct B -> B
      ch_14_canonical_p11.json: 1 of 1 item(s) re-ordered
          #1 None #1: A–D now hold CABD · correct A -> B
