# Library certification · english IX ch 9 · 20260814_112936
...
PASS  ch_09_canonical.json: every question_type is a known assessment type (0 not)
      ADVISORY ch_09_canonical.json: ['EXTRACT_ANALYSIS', 'MATCH', 'MCQ', 'PROJECT', 'SCR', 'TRUE_FALSE'] used by exactly one item in the whole library — check it against the constitution's type table
...
serve sweep: {"5": "fill/single -4s", "6": "fill/single -4s", "7": "fill/single -4s", "8": "fill/forward -2s", "9": "fill/forward -2s", "10": "fill/forward", "11": "identity", "12": "surrender", "13": "surrender"}
