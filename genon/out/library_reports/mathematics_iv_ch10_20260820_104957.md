# Library certification · mathematics IV ch 10 · 20260820_104957
...
PASS  ch_10_canonical.json: every section the chapter summary carries is anchored by some unit (8 summary section(s) vs 8 registry entr(ies))
...
PASS  ch_10_canonical.json: register scan reached the band text (35 band(s) read: {'activity_title': 12, 'materials': 30, 'teacher_notes': 12, 'time_bands': 35, 'homework': 4})
PASS  ch_10_canonical.json: register clean (0 ban hit(s))
PASS  ch_10_canonical_p10.json: register scan reached the band text (28 band(s) read: {'activity_title': 10, 'materials': 28, 'teacher_notes': 10, 'time_bands': 28, 'homework': 6})
PASS  ch_10_canonical_p10.json: register clean (0 ban hit(s))
PASS  ch_10_canonical_p07.json: register scan reached the band text (26 band(s) read: {'activity_title': 7, 'materials': 16, 'teacher_notes': 7, 'time_bands': 26, 'homework': 3})
...
options arranged: 5 of 15 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ...
      ch_10_canonical_p07.json: 3 of 5 item(s) re-ordered
          #1 None #1: A–D now hold ADBC · correct D -> B
          #4 None #4: A–D now hold BDAC · correct A -> C
          #6 None #6: A–D now hold ADCB · correct D -> B
      ch_10_canonical_p10.json: 2 of 4 item(s) re-ordered
          #8 None #8: A–D now hold BACD · correct C -> C
          #10 None #10: A–D now hold CBAD · correct A -> C
