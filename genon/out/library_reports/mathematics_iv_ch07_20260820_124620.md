# Library certification · mathematics IV ch 7 · 20260820_124620
...
PASS  ch_07_canonical_p11.json: register scan reached the band text (36 band(s) read: {'activity_title': 11, 'materials': 28, 'teacher_notes': 11, 'time_bands': 36, 'homework': 3})
PASS  ch_07_canonical_p11.json: register clean (0 ban hit(s))
PASS  ch_07_canonical_p08.json: register scan reached the band text (32 band(s) read: {'activity_title': 8, 'materials': 21, 'teacher_notes': 8, 'time_bands': 32, 'homework': 6})
...
serve sweep: {"6": "fill/single -1s", "7": "fill/single", "8": "identity", "9": "fill/single", "10": "fill/single", "11": "identity", "12": "synthesis", "13": "identity", "14": "surrender", "15": "surrender"}

options arranged: 4 of 18 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ch_07_canonical.json: 0 of 8 item(s) re-ordered
      ch_07_canonical_p08.json: 4 of 6 item(s) re-ordered
          #1 None #1: A–D now hold BADC · correct B -> A
          #2 None #2: A–D now hold BDCA · correct B -> A
          #5 None #5: A–D now hold DABC · correct B -> C
          #12 None #12: A–D now hold ACBD · correct B -> C
