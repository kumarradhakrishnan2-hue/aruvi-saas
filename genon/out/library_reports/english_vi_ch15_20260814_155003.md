# Library certification · english VI ch 15 · 20260814_155003
...
PASS  ch_15_canonical.json: every question_type is a known assessment type (0 not)
      ADVISORY ch_15_canonical.json: ['ECR', 'FILL_IN', 'MATCH', 'MCQ', 'PROJECT', 'TRUE_FALSE'] used by exactly one item in the whole library — check it against the constitution's type table
...
serve sweep: {"3": "fill/forward -3s", "4": "fill/forward -3s", "5": "fill/forward -3s", "6": "fill/single -2s", "7": "fill/forward", "8": "identity", "9": "surrender", "10": "surrender"}
