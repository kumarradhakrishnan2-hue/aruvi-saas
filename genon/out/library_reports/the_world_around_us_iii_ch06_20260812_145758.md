# Library certification · the_world_around_us III ch 6 · 20260812_145758
...
options arranged: 7 of 12 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ...
      ch_06_canonical_p10.json: 3 of 3 item(s) re-ordered
          #1 C-1.1 U1: A–D now hold DACB · correct A -> B
          #4 C-1.1 U4: A–D now hold BCDA · correct A -> D
          #10 C-1.1 U10: A–D now hold CBAD · correct A -> C
      ch_06_canonical_p14.json: 4 of 4 item(s) re-ordered
          #1 C-1.2 U1: A–D now hold DBAC · correct B -> B
          #3 C-1.1 U3: A–D now hold DCBA · correct B -> C
          #6 C-1.2 U6: A–D now hold CBAD · correct C -> A
          #13 C-1.1 U13: A–D now hold ADCB · correct None -> None
