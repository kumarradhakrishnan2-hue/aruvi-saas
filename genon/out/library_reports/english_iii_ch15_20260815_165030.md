# Library certification · english III ch 15 · 20260815_165030

plan: counts [7, 4] · basis authored_standard · registry 4 sections

FAIL  library complete: ['ch_15_canonical.json'] vs plan [7, 4]
...
serve sweep: {"2": "fill/single -2s", "3": "fill/single -2s", "4": "fill/single -1s", "5": "fill/single", "6": "fill/single", "7": "identity", "8": "surrender", "9": "surrender"}
...
options arranged: 2 of 2 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ch_15_canonical.json: 2 of 2 item(s) re-ordered
          ...
          #3 None #3: A–D now hold BCAD · correct B -> A
