# Library certification · social_sciences IX ch 1 · 20260812_162653
...
FAIL  ch_01_canonical.json: register clean (2 ban hit(s))
      U5 time_bands[3] 40-50 [forward] …our disciplines on the board with their drought-web branch, previewing the four dedicated discipline sections without naming upcom…
...
options arranged: 5 of 6 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ch_01_canonical.json: 5 of 6 item(s) re-ordered
          #1 C-9.1 U2: A–D now hold DCBA · correct B -> C
          #6 C-1.1 U8: A–D now hold BACD · correct B -> A
          #9 C-1.4 U4: A–D now hold CBDA · correct C -> A
          #12 C-4.4 U7: A–D now hold ACBD · correct B -> C
          #18 C-7.1 U11: A–D now hold ACBD · correct B -> C
