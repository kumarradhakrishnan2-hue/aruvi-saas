# Library certification · english IX ch 8 · 20260814_135117
...
PASS  ch_08_canonical_p04.json: register scan reached the band text (18 band(s) read: {'activity_title': 4, 'materials': 5, 'teacher_notes': 4, 'time_bands': 18, 'homework': 3})
...
item counts per competency — ADVISORY, does not gate; basis: derived (modal count across this library — no constitution row yet)
      ...
      ch_08_canonical_p04.json: 0 items vs 0 expected
...
serve sweep: {"2": "fill/forward -2s", "3": "fill/forward -2s", "4": "identity", "5": "rescue/complete (from 7)", "6": "fill/forward", "7": "identity", "8": "surrender", "9": "surrender"}
...
options arranged: 2 of 4 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ...
      ch_08_canonical_p04.json: 2 of 2 item(s) re-ordered
          #1 None #1: A–D now hold BDAC · correct B -> A
          #3 None #3: A–D now hold 312 · correct 3 -> 1
QUARANTINED  ch_08_canonical_p04.json -> backup/quarantine/english/ix/ch_08_canonical_p04_20260814_135117.json
