# Library certification · mathematics V ch 5 · 20260819_174035
...
serve sweep: {"8": "fill/single -2s", "9": "fill/single -1s", "10": "fill/single -1s", "11": "fill/single", "12": "synthesis", "13": "synthesis", "14": "synthesis", "15": "synthesis", "16": "identity", "17": "surrender", "18": "surrender"}
...
options arranged: 5 of 5 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ch_05_canonical.json: 5 of 5 item(s) re-ordered
          #3 None #3: A–D now hold ACDB · correct A -> A
          #6 None #6: A–D now hold BDCA · correct C -> C
          #7 None #7: A–D now hold DBCA · correct B -> B
          #10 None #10: A–D now hold ACDB · correct B -> D
          #14 None #14: A–D now hold DABC · correct A -> B
