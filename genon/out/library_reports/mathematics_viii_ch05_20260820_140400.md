# Library certification · mathematics VIII ch 5 · 20260820_140400
...
PASS  ch_05_canonical.json: every section the chapter summary carries is anchored by some unit (3 summary section(s) vs 3 registry entr(ies))
...
PASS  ch_05_canonical.json: register scan reached the band text (48 band(s) read: {'activity_title': 12, 'materials': 24, 'teacher_notes': 12, 'time_bands': 48, 'homework': 4, 'visual_aids': 1})
PASS  ch_05_canonical.json: register clean (0 ban hit(s))
PASS  ch_05_canonical_p10.json: register scan reached the band text (40 band(s) read: {'activity_title': 10, 'materials': 20, 'teacher_notes': 10, 'time_bands': 40, 'homework': 4})
PASS  ch_05_canonical_p10.json: register clean (0 ban hit(s))
PASS  ch_05_canonical_p07.json: register scan reached the band text (28 band(s) read: {'activity_title': 7, 'materials': 14, 'teacher_notes': 7, 'time_bands': 28, 'homework': 6})
...
PASS  ch_05_canonical_p07.json: no stem points at a figure the item does not carry (0 does)
...
item counts per competency — ADVISORY, does not gate; basis: derived (modal count across this library — no constitution row yet)
      ...
      ch_05_canonical_p07.json: 0 items vs 0 expected
...
options arranged: 0 of 6 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ...
      ch_05_canonical_p07.json: 0 of 2 item(s) re-ordered
      ch_05_canonical_p10.json: 0 of 1 item(s) re-ordered
