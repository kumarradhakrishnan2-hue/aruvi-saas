# Library certification · the_world_around_us V ch 5 · 20260813_164800
...
PASS  ch_05_canonical.json: register scan reached the band text (63 band(s) read: {'activity_title': 16, 'materials': 66, 'visual_aids': 10, 'teacher_facilitation_note': 16, 'time_bands': 63})
PASS  ch_05_canonical.json: register clean (0 ban hit(s))
      ADVISORY ch_05_canonical.json: 2 artefact-dependency hit(s) — a unit reaching for something a PREVIOUS sitting produced. Read them: the brief forbids it, certification cannot.
        U16 materials[0]: 'prepared previously' — Group posters and charts prepared previously
        U16 time_bands[0] 0-5: 'set up their posters' — Groups set up their posters or displays around the classroom. The teacher explains the…
PASS  ch_05_canonical_p13.json: register scan reached the band text (52 band(s) read: {'activity_title': 13, 'materials': 54, 'visual_aids': 10, 'teacher_facilitation_note': 13, 'time_bands': 52})
PASS  ch_05_canonical_p13.json: register clean (0 ban hit(s))
PASS  ch_05_canonical_p10.json: register scan reached the band text (40 band(s) read: {'activity_title': 10, 'materials': 47, 'visual_aids': 7, 'teacher_facilitation_note': 10, 'time_bands': 40})
