# Library certification · english IV ch 12 · 20260815_165033

plan: counts [10, 8, 6] · basis authored_standard · registry 5 sections

FAIL  library complete: ['ch_12_canonical.json'] vs plan [10, 8, 6]
...
PASS  ch_12_canonical.json: every question_type is a known assessment type (0 not)
      ADVISORY ch_12_canonical.json: ['MATCH', 'WRITING_TASK'] used by exactly one item in the whole library — check it against the constitution's type table
...
options arranged: 3 of 3 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ch_12_canonical.json: 3 of 3 item(s) re-ordered
          ...
          #7 None #7: A–D now hold BACD · correct D -> D
