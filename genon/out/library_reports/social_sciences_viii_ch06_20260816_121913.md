# Library certification · social_sciences VIII ch 6 · 20260816_121913
...
options arranged: 0 of 28 item(s) re-ordered this run. Nothing is written to the artefact (founder ruling 2026-08-04), so a 0 here means only that nothing was left to move — on a re-run that is expected, and it is NOT evidence the model arranged them unaided. Read this number on the FIRST pass of a freshly generated library or not at all.
      ch_06_canonical.json: 0 of 9 item(s) re-ordered
      ch_06_canonical_p07.json: 0 of 10 item(s) re-ordered
      ch_06_canonical_p10.json: 0 of 9 item(s) re-ordered
