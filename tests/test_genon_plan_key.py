...
check("readable shape", k17 == "ch_05_50m17_e05_c20260726112240.json", k17)
...
if live is None:
    ...
    check("live canonical keys cleanly", lk.startswith("ch_05_50m16_e05_c") and lk.endswith("_p.json"), lk)
