...
## v3.9 — 2026-08-11 · the narration format loses its JSON quote hazard (cross-stage)

Cross-stage amendment made after S8's C1 lost a paid compact to it. Paired with the same edit at mathematics preparatory and all three English stages.
...
Artefacts: `genon/out/stage_prep_mathematics_preparatory/` — `lp_mathematics_middle_v3.8_pre.txt` ·
`curlyquote_mathematics_middle.diff` · `apply_curly_quote_narration.py` (one script, all five
