...
Artefacts: `genon/out/stage_prep_mathematics_preparatory/` — `lp_mathematics_preparatory_v1.3_pre.txt` ·
`curlyquote_mathematics_preparatory.diff` · `apply_curly_quote_narration.py` (one script, all five
